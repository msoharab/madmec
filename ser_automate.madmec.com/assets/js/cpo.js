	function ClientPurchaseOrder() {
	    ...
	    function uploadCPO() {
	        ...
	        if (CPO.cpo.require.prjmid != 0) {
	            ...
	            $('html, body').animate({
	                scrollTop: Number($('#' + CPO.cpo.require.QRT_msg).offset().top) - 95
	            }, 'slow');
	        ...
	        /* Ref No */
	        if ($(CPO.cpo.refno).val().length < 101) {
	            flag = true;
	            ...
	            $('html, body').animate({
	                scrollTop: Number($(CPO.cpo.refnomsg).offset().top) - 95
	            }, 'slow');
	            $(CPO.cpo.refno).focus();
	            return;
	        }
	        ...
	        if ($(CPO.cpo.doi).val().match(/(\d{4})-(\d{2})-(\d{2})/)) {
	            ...
	            $('html, body').animate({
	                scrollTop: Number($(CPO.cpo.doimsg).offset().top) - 95
	            }, 'slow');
	            $(CPO.cpo.doi).focus();
	            return;
	        }
	        ...
	        if ($(CPO.cpo.file).val().length) {
	            ...
	            $('html, body').animate({
	                scrollTop: Number($(CPO.cpo.filemsg).offset().top) - 95
	            }, 'slow');
	            $(CPO.cpo.file).focus();
	            return;
	        }
	        if (flag) {
	            var options = {
	                ...
	                success: function(json, statusText, xhr, $form) {
	                    ...
	                    $(CPO.cpo.bar).width(CPO.cpo.percentVal)
	                    $(CPO.cpo.percent).html(CPO.cpo.percentVal);
                           // $(CPO.cpo.status).html('<h3>Uploaded and saved client purchase order</h3>');
	                ...
	                switch (data) {
	                    ...
	                    default:
	                        ...
	                        var header = '<div class="col-md-12">' +
	                            ...
	                            '<div class="panel-heading">  List of Client Purchase Order </div>' +
