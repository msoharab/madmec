...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(100,5,$_SESSION['BillingDetails']['COMPANAY_NAME'],'','','C');
$pdf->Ln();
...
$pdf->Ln();
$pdf->Line(5,85,130,85);
$pdf->Ln();
$pdf->SetFont('Arial','',7);
$str = str_replace(PHP_EOL,"", $_SESSION["BillingDetails"]["COMPANY_ADDRESS"]);
$pdf->Cell(120,5,$_SESSION['BillingDetails']['COMPANY_ADDRESS']."  LandLine : ".$_SESSION['BillingDetails']['COMPANY_LANDLINE']."  Email : ".$_SESSION['BillingDetails']['COMPANY_EMAIl'],'','','L');
$parameters = array(
