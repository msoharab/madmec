...
?>
<nav class="navbar navbar-default navbar-cls-top" role="navigation" id="nav-top">
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<p class="help-block" id="pass_msg">Press enter or go button to SignIn.</p>
                                    ...
                                    <button type="button" class="btn btn-lg btn-primary btn-block" href="javascript:void(0);" id="sigininbut"><i class="fa fa-sign-in fa-fw fa-2x"></i> &nbsp;SignIn</button>
				</fieldset>
			</div>
		</div>
	</div>
