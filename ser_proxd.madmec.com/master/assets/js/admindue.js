                                ...
                                default:
                                        ...
                                        if(res.status=="success")
                                        {
                                            var header='<table class="table table-striped table-bordered table-hover" id="list_dues_table">';
                                             var tableHeading='<thead><th>#</th><th>Clinic Name</th><th>Doctor Name</th><th>Mobile</th><th>Email</th><th>Username</th><th>Due Amount</th><th>Due Date</th><th>MOP</th><th>PAY</th></tr></thead><tbody>';
