<?php 
	...
	include_once(DOC_ROOT.PHP.INC."header.php"); 
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Admin Dashboard Prototype sample dummy</h2>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
          ...
          <div class="main-temp-back">
            <div class="panel-body">
              <div class="row">
                <div class="col-xs-6"> <i class="fa fa-cloud fa-3x"></i> Bangalore City </div>
                <div class="col-xs-6">
