...
?>	
 ...
 <script src="<?php echo URL.ASSET_JS; ?>fileuploader/jquery.simpleFilePreview.js" type="text/javascript"></script>
 <a href="<?php echo URL.ASSET_JS; ?>fileuploader/package.json"></a>
 <!--	datatables  -->
	<script src="<?php echo URL.ASSET_JS; ?>dataTables/jquery.dataTables.js"></script>
	<script src="<?php echo URL.ASSET_JS; ?>dataTables/dataTables.bootstrap.js"></script>
