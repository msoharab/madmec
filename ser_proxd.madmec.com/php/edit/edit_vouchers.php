                        ...
                        <div class="panel-body">
							<form role="form">
								<div class="form-group">
									...
									<input type="hidden" id="src_ac" class="form-control" value="'.$voucher['source_id'].'" readonly>
								...
								<div class="form-group">
									<label>Date of Receipt: </label>
										...
										<input type="hidden" id="alt-date" class="form-control" value="'.$voucher['date'].'" >
								...
								<div class="form-group">
									...
									<input id="mobile" type="number" class="form-control" value="'.$voucher['phone'].'" placeholder="9900000000">
