...
//Display the cheque number :--
function number_allow_chequeno() {
	$("#cheque_no").keypress(function (e) {
		
     // digit  and alphabets then display error and don't type anything
     if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57) && (e.which < 65 || e.which > 90) && (e.which < 97 || e.which > 122)) {
        //display error message
        $("#err_cheque_no").html("Alphabets & Digits Only").show().fadeOut("slow");
               return false;
    }
	});
}
...
//Display the Paid to :--
function allow_Paidto() {
	$("#name").keypress(function (e) {
		
     // digit  and alphabets then display error and don't type anything
     if (e.which != 8 && e.which != 0  && (e.which < 65 || e.which > 90) && (e.which < 97 || e.which > 122)) {
        //display error message
        $("#err_name").html("Alphabets & Digits Only").show().fadeOut("slow");
               return false;
    }
	});
}

//Display the email validation
function allow_email() {
	$("#email").keypress(function (e) {
		
     // digit  and alphabets then display error and don't type anything
     if (e.which != 8 && e.which != 0  && (e.which < 48 || e.which > 57) && (e.which < 46 || e.which > 46) && (e.which < 32 || e.which > 32) && (e.which < 95 || e.which > 95) && (e.which < 65 || e.which > 90) && (e.which < 97 || e.which > 122)) {
        //display error message
        $("#err_email").html("Alphabets & Digits Only").show().fadeOut("slow");
               return false;
    }
	});
}
