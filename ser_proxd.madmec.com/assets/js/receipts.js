...
//Display the Received from  :--
function allow_Receivedfrom() {
	$("#name").keypress(function (e) {
		
     // digit  and alphabets then display error and don't type anything
     if (e.which != 8 && e.which != 0  &&  (e.which < 32 || e.which > 32) && (e.which < 65 || e.which > 90) && (e.which < 97 || e.which > 122)) {
        //display error message
        $("#err_name").html("Alphabets Only").show().fadeOut("slow");
               return false;
    }
	});
}
