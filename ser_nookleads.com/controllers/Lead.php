...
class Lead extends BaseController {
    ...
    function __construct($para = false) {
        parent::__construct();
        $this->para = $para;
        $this->LeadMod = new NewLead_Model();
        $this->LeadMod->setLeadData($this->postPara);
    }
    ...
    public function listDealLeadQuotation() {
        if (isset($_SESSION["ListNewLead"]) && count($_SESSION["ListNewLead"]) > 0) {
            $this->baseview->listLead = $this->LeadMod->listDealLead();
    ...
    public function approvalLead($param = false) {
        $this->baseview->setjsonData($this->LeadMod->approvalLead($param));
        echo $this->baseview->renderJson();
    }
    public function disApprovalLead($param = false) {
        $this->baseview->setjsonData($this->LeadMod->disApprovalLead($param));
        echo $this->baseview->renderJson();
    }
    public function changeLeadPreferences($param = false) {
        $this->baseview->setjsonData($this->LeadMod->changeLeadPreferences());
        echo $this->baseview->renderJson();
    }
    public function reportLead($param = false) {
        $this->baseview->setjsonData($this->LeadMod->reportLead());
        echo $this->baseview->renderJson();
    }
    public function subscribeBusiness($param = false) {
        $this->baseview->setjsonData($this->LeadMod->subscribeBusiness());
        echo $this->baseview->renderJson();
    }
    public function addQuotation($param = false) {
        $this->baseview->setjsonData($this->LeadMod->addQuotation($param));
        echo $this->baseview->renderJson();
    }
    public function approvalLeadQuotation($param = false) {
        $this->baseview->setjsonData($this->LeadMod->approvalLeadQuotation($param));
        echo $this->baseview->renderJson();
    }
    public function disApprovalLeadQuotation($param = false) {
        $this->baseview->setjsonData($this->LeadMod->disApprovalLeadQuotation($param));
        echo $this->baseview->renderJson();
    }
    public function changeLeadQuotationPreferences($param = false) {
        $this->baseview->setjsonData($this->LeadMod->changeLeadQuotationPreferences());
        echo $this->baseview->renderJson();
    }
    public function addQuotationWo($param = false) {
        $this->baseview->setjsonData($this->LeadMod->addQuotationWo($param));
        echo $this->baseview->renderJson();
    }
    public function approvalLeadQuotationWo($param = false) {
        $this->baseview->setjsonData($this->LeadMod->approvalLeadQuotationWo($param));
        echo $this->baseview->renderJson();
    }
    public function disApprovalLeadQuotationWo($param = false) {
        $this->baseview->setjsonData($this->LeadMod->disApprovalLeadQuotationWo($param));
        echo $this->baseview->renderJson();
    }
    public function changeLeadQuotationWoPreferences($param = false) {
        $this->baseview->setjsonData($this->LeadMod->changeLeadQuotationWoPreferences());
        echo $this->baseview->renderJson();
    }
}
?>