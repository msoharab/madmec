...
class GooglePlus extends BaseController {
    ...
    function __construct($para = false) {
        ...
        $this->client_id = '637132069355-cdmnrousu4tr5r648dr9nmm3vq3q2smt.apps.googleusercontent.com';
        $this->client_secret = 'LxM1jC-2Y49MxGJmlEPzljBn';
        $this->gotoDeal();
    }
    public function Index() {
        ...
        if (isset($_SESSION['GP_access_token']) && $_SESSION['GP_access_token']) {
            ...
            $this->baseview->GPRequest = '<a href="' . $client->createAuthUrl() . '" class="btn btn-google btn-google-plus">Login / Register with GooglePlus!</a>';
        }
