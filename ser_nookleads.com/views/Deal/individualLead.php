<?php
$create = (array) $this->idHolders["nookleads"]["deal"]["create"];
?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class=""
                  ...
                  action="<?php echo $this->config["URL"] . $this->config["CTRL_18"]; ?>UploadPic/leads"
                  method="lead"
                ...
                <fieldset>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="<?php echo $create["create"]; ?>" id="<?php echo $create["create"]; ?>">Lead</button>
                    </div>
                </fieldset>
            </form>
        </div>
