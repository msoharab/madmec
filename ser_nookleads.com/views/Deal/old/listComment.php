<?php
$listQuotation = $this->idHolders["nookleads"]["deal"]["list"]["quotation"]["list"];
if ($this->quotationNo > 0) :
                    ...
                    <div class="panel arrow left">
                        <div class="panel-heading right">
                            <div class="btn-group pull-right"
                                 id="<?php echo $listQuotation["pref"]["parentDiv"] . $newRes[$i]["leads"]["quotations"]["pc_id"][$lp]; ?>">
                                <button type="button" class="btn btn-default dropdown-toggle btn-sm" data-toggle="dropdown">
                                    <?php echo $listQuotation["pref"]["text"]; ?>
                                </button>
                                <ul class="dropdown-menu slidedown"
                                    id="<?php echo $listQuotation["pref"]["outputDiv"] . $newRes[$i]["leads"]["quotations"]["pc_id"][$lp]; ?>">
                                        <?php
                                        for ($lop = 0; $lop < count($listQuotation["pref"]) && isset($listQuotation["pref"][$lop]); $lop++) {
                                            if ($listQuotation["pref"][$lop]["status_id"] === 4):
                                                ?>
                                            <li name="<?php echo $newRes[$i]["leads"]["quotations"]["pc_id"][$lp]; ?>" id="<?php echo $listQuotation["pref"][$lop]["action"]; ?>">
                                                <a href="javascript:void(0);"
                                                   id="<?php echo $listQuotation["pref"][$lop]["id"] . $newRes[$i]["leads"]["quotations"]["pc_id"][$lp]; ?>"
                                                   name="<?php echo $listQuotation["pref"][$lop]["acid"]; ?>"
                                                   class="<?php echo $listQuotation["pref"][$lop]["class"]; ?>">
                                                    <small><?php echo $listQuotation["pref"][$lop]["text"]; ?></small>
                                                </a>
                                            </li>
                        ...
                        <div class="panel-body">
                            <header class="text-left">
                                ...
                                <!--<time class="quotation-date" datetime="<?php echo $leadQuotationTime; ?>">
                                    <small><i class="fa fa-clock-o"></i> <?php echo $leadQuotationTime; ?></small>
                                </time>-->
                            </header>
                            <div>
                                <p>
                                ...
                                <?php else : ?>
                                    <div class="<?php echo $listQuotation["content"]; ?>">
                                        <?php echo $newRes[$i]["leads"]["quotations"]["quotations"][$lp]; ?>
                                    </div>
                                <?php endif; ?>
                                </p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="col-lg-4">
                                        ...
                                        <a href="javascript:void(0);" id="<?php echo $listQuotation["approval"]["counter"] . $newRes[$i]["leads"]["quotations"]["pc_id"][$lp]; ?>">
                                            <?php echo $quotationNoApprovals; ?>
                                        </a> approvals
                                    </div>
                                    <div class="col-lg-4">
                                        <i class="fa fa-envelope-square thumbs-up"></i>
                                        <a href="javascript:void(0);" id="<?php echo $listQuotation["wo"]["counter"] . $newRes[$i]["leads"]["quotations"]["pc_id"][$lp]; ?>">
                                            <?php echo $this->quotationNoWo; ?>
                                        </a> wo
                                    </div>
                                    <div class="col-lg-4">
                                        <a href="javascript:void(0);" class="ellipsis" onclick="$('#comrtarget<?php echo $i . '_' . $lp; ?>').slideToggle('slow');">
                        ...
                        <div class="footer" id="comrtarget<?php echo $i . '_' . $lp; ?>" style="display:none;">
                            <div class="col-lg-12">
    ...
    ?>
    <div class="col-lg-12 text-center" id="<?php echo $listQuotation["loader"]; ?>"></div>
