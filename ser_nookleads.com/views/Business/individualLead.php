<?php
$create = (array) $this->idHolders["nookleads"]["business"]["home"]["create"];
?>
            ...
            <form class="" 
                ...
                <fieldset>
                    <div class="modal-body">
                        <div class='conatiner'>
                            <div class="row">
                                <div class="col-lg-12">
                                    <input type="file" 
                                           name="<?php echo $create["leadImg"]; ?>"
                                           id="<?php echo $create["leadImg"]; ?>" />
                                </div>
                            </div>
                            <h4 class='text-center'>Upload / Lead picture, we accept jpg, & png format. <br />(<strong>Max size:</strong>2.0 MB & <strong>Max Upload:</strong> 30 pics / day)</h4>
                            <div class="row">
                                <div class="col-lg-12"><h4>Title of the lead.</h4></div>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <input type="hidden" class="form-control" 
                                           id="<?php echo $create["businessID"]; ?>" 
                                           name="<?php echo $create["businessID"]; ?>"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="<?php echo $create["create"]; ?>" id="<?php echo $create["create"]; ?>" data-business="<?php echo $this->BusinessId; ?>">Lead</button>
                    </div>
                </fieldset>
            </form>
        </div>
