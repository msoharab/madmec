<!-- modal for Business report start-->
            ...
            <form id="<?php echo $chreport["form"]; ?>" 
                ...
                <fieldset>
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="<?php echo $chreport["moodalId"]; ?>"><strong>Report This Business</strong></h4>
                    </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                for ($lp = 0; $lp < count($chreport) && isset($chreport[$lp]); $lp++) {
                                    if ($chreport[$lp]["status_id"] === 4):
                                        ?>
                                        <div class="input-group" name="<?php echo $businessId; ?>" data-bind="<?php echo $chreport[$lp]["acid"]; ?>">
                                            <span class="input-group-addon woborder">
                                                <input type="radio" aria-label="..." id="<?php echo $chreport[$lp]["id"] . $businessId; ?>" 
