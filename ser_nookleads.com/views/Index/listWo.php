<?php
$listQuotationWo = $this->idHolders["nookleads"]["index"]["list"]["quotation"]["list"]["wo"]["list"];
...
if (isset($newRes[$i]["leads"]["quotations"]["wos"]["pcr_ct"]) && isset($newRes[$i]["leads"]["quotations"]["wos"]["pcr_ct"][$lpcr]) && $newRes[$i]["leads"]["quotations"]["wos"]["pcr_ct"][$lpcr] != '')
    $this->quotationNoWo = $newRes[$i]["leads"]["quotations"]["wos"]["pcr_ct"][$lpcr];
if ($this->quotationNoWo > 0) :
                ...
                <ul class="list-inline">
                    <!--<li class="pull-right">
                        <a href="javascript:void(0);" 
                           ...
                           id="<?php echo $listQuotationWo["approval"]["counter"] . $newRes[$i]["leads"]["quotations"]["wos"]["pcr_id"][$lpcr][$lpcri]; ?>">
                            Approvals (<?php echo $quotationWoNoApprovals; ?>)
                        </a> 
                    </li>!-->
                </ul>
            </div>
    ...
    ?>
    <div class="col-lg-12">
        <h5>No Work Orders to view folks!!! <span class="<?php echo $listQuotationWo["content"]; ?>">:-O</span></h5>
    </div>
<?php
endif;
?>
