...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-7" id="show-lead" style="display:none;">&nbsp; </div>
            ...
            <div class="thumbnail">
                ...
                <div class="dropdown close-lead">
                    ...
                    <div class="dropdown-menu close-lead-dd">
                        ...
                        <div class="close-lead-dd-item"><a href="#">Block this business</a></div>
                        <div class="close-lead-dd-item-child"><a href="#">Remove this section</a></div>
                    </div>
                </div>
                <div class="">
                    ...
                    ?>assets/img/photo1.jpg">
                        <img src="<?php echo $this->config["URL"] . $this->config["VIEWS"]; ?>assets/img/photo1.jpg" alt=""/>
                    </a>
                    <div class="hidden">
                ...
                <div class="caption">
                    <div class="row">
                        ...
                        <div id="target1" style="display:none;"><hr />
                            ...
                            <ul id="quotations">
                                <i class="fa fa-thumbs-o-up thumbs-up"></i> <a href="#" id="shakil"> 786</a> people approval this
                                <a href="#"> . </a>
...
<div class="modal fade" id="contactus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="" method="lead" >
                    <div class="form-group">
