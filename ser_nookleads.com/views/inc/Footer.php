...
echo $this->config["URL"] .
 ...
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_16"];
?>jquery.mousewheel.js" type="text/javascript"></script>
<script data-autoloader="false" type="text/javascript" src="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET_PLG"] .
...
echo $this->config["URL"] .
 ...
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_13"];
?>icheck.min.js" type="text/javascript"></script>
<script data-autoloader="false" src="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_23"];
?>js/picedit.edit.js" type="text/javascript"></script>
<script data-autoloader="false" src="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
...
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET"];
?>dist/js/app.min.js" type="text/javascript"></script>
<script data-autoloader="false" src="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_16"];
?>jquery.cssemoticons.min.js" type="text/javascript"></script>
<script data-autoloader="false" src="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_16"];
?>jquery.twbsPagination.js" type="text/javascript"></script>
<script data-autoloader="false" src="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_28"];
?>all-v2138186.js" type="text/javascript"></script>
<script data-autoloader="false" src="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_29"];
?>platform.js" type="text/javascript"></script>
<link href="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_24"];
?>css/s2-docs.css" rel="stylesheet" type="text/css" />
<link href="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET_PLG"] .
...
echo $this->config["URL"] .
 ...
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_23"];
?>css/picedit.min.css" rel="stylesheet" type="text/css" />
<link href="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET"] .
...
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET_BST"];
?>css/lead-quotation-wo.css" rel="stylesheet" type="text/css" />
<link href="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET"];
?>dist/css/AdminLTE.css" rel="stylesheet" type="text/css" />
<link href="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET"];
...
echo $this->config["URL"] .
 ...
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_16"];
?>jquery.cssemoticons.css" media="screen" rel="stylesheet" type="text/css" />
<link href="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET_PLG"] .
...
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET"];
?>css/nookleads-colors.css" rel="stylesheet" type="text/css" />
<link href="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET"];
?>css/nookleads-style.css" rel="stylesheet" type="text/css" />
<link href="<?php
echo $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET"];
?>css/quotations.css" rel="stylesheet" type="text/css" />
...
<?php
echo '<script data-autoloader="true" type="text/javascript" data-autoloader="true" src="' .
 $this->config["URL"] .
 $this->config["VIEWS"] .
 $this->config["ASSSET_PIC"] .
 $this->config["CONTROLLERS"] . $this->controller . '.js" ></script>';
/*
if ($_SESSION["CURR_CTRL"] === 'GooglePlus') {
    echo '<script data-autoloader="false" type="text/javascript" data-autoloader="true" '.
            'src="https://apis.google.com/js/client.js?onload=handleClientLoad"></script>';
}
if ($_SESSION["CURR_CTRL"] === 'Facebook') {
    echo '<script data-autoloader="false" type="text/javascript" '.
...
<script language="javascript" charset="UTF-8">
    $(document).ready(function () {
        ...
        /*
         ...
         $(this).css({height:Number($(document).innerHeight()-25)+'px'});
         }
         });
         setTimeout(function () {
