<?php
$filterLead = (array) $this->idHolders["nookleads"]["business"]["header"]["filter"]["list"];
?>
                    ...
                    <div class="modal-body">
                        <div class='conatiner'>
                            <div class="row">
                                ...
                                <div class="col-lg-12" id="<?php echo $this->idHolders["nookleads"]["business"]["header"]["filter"]["sections"]["outputDiv"]; ?>"></div>
                                <div class="col-lg-12">&nbsp;</div>
