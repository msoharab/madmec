<?php
$header = isset($this->idHolders["nookleads"]["deal"]["header"]) ? (array) $this->idHolders["nookleads"]["deal"]["header"] : false;
$chSearch = isset($this->idHolders["nookleads"]["deal"]["header"]["businessSearch"]) ? (array) $this->idHolders["nookleads"]["deal"]["header"]["businessSearch"] : false;
?>
<!DOCTYPE html>
<html>
    <head>
...
?>dealHeader.js"></script>
    ...
    <body class="wysihtml5-supported skin-red-light sidebar-collapse fixed">
        <div class="wrapper">
                    ...
                    <div class="container">
                        ...
                        <div style="height: 1px;" aria-expanded="false" class="navbar-collapse pull-left collapse" id="navbar-collapse">
                            <ul class="nav navbar-nav">
                                <li><a href="<?php echo $this->config["URL"] . $this->config["CTRL_7"]; ?>B2B" >B2B</a></li>
                                <li><a href="<?php echo $this->config["URL"] . $this->config["CTRL_7"]; ?>B2C" >B2C</a></li>
                                <li><a href="<?php echo $this->config["URL"] . $this->config["CTRL_7"]; ?>B2G" >B2G</a></li>
                                <li><a href="<?php echo $this->config["URL"] . $this->config["CTRL_7"]; ?>C2C" >C2C</a></li>
                            </ul>
            ...
            <?php
            //require_once 'leadFilterDeal.php';
            ?>
