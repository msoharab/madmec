<?php
$header = isset($this->idHolders["nookleads"]["header"]) ? (array) $this->idHolders["nookleads"]["header"] : false;
?>
<!DOCTYPE html>
<html>
    <head>
                ...
                <nav class="navbar navbar-default">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" 
                           href="<?php echo $this->config["URL"] . $this->config["CTRL_7"]; ?>">nookleads</a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="border-right-black concept" 
                                ...
                                <a id="<?php echo $this->idHolders["nookleads"]["header"]["filter"]["list"]["parentBut"]; ?>" 
                                   name="<?php echo $this->idHolders["nookleads"]["header"]["filter"]["list"]["parentBut"]; ?>" 
                                   data-toggle="modal" 
                                   data-target="#<?php echo $this->idHolders["nookleads"]["header"]["filter"]["list"]["parentDiv"]; ?>" 
                                   data-whatever="@mdo">
