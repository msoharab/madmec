          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-manufacturedate"><?php echo $column_manufacture_date; ?></label>
                <div class="col-sm-3">
                <div class="input-group date">
                    <input type="text" name="manufacturedate" value="<?php echo $manufacturedate; ?>" placeholder="<?php $column_manufacture_date ?>" data-date-format="YYYY-MM-DD" id="input-date-manufacture" class="form-control" />
                ...
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-expirydate"><?php echo $column_expire_date; ?></label>
                <div class="col-sm-3">
                <div class="input-group date">
                    <input type="text" name="expirydate" value="<?php echo $expirydate; ?>" placeholder="<?php $column_expire_date ?>" data-date-format="YYYY-MM-DD" id="input-date-expiry" class="form-control" />
                    <span class="input-group-btn">
                    <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                    </span></div>
                </div>
