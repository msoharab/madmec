<?php
$filterPost = (array) $this->idHolders["pic3pic"]["index"]["header"]["filter"]["list"];
?>
                    ...
                    <div class="modal-body">
                        <div class='conatiner'>
                            <div class="row">
                                ...
                                <div class="col-lg-12" id="<?php echo $this->idHolders["pic3pic"]["index"]["header"]["filter"]["sections"]["outputDiv"]; ?>"></div>
                                <div class="col-lg-12">&nbsp;</div>
