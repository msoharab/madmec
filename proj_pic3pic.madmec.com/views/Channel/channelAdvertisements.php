...
$channelAdv = isset($this->ChannelDetails["chadd"]["chadd_img"][0]) && !empty($this->ChannelDetails["chadd"]["chadd_img"][0]) 
        ? $this->ChannelDetails["chadd"]["chadd_img"][0] : $this->config["DEFAULT_CHANEL_ADV_IMG"];
?>
<div class="panel">
    ...
    <div class="panel-body">
        <img src="<?php echo $channelAdv; ?>" class="img-responsive">
    </div>
                ...
                <fieldset>
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title" id="myModalLabel">Channel Advertisement</h3>
                        </div>
                        <div class="modal-body">
                            <input
                                type="file"
                                name="<?php echo $chad["proIMGName"]; ?>"
                                id="<?php echo $chad["postImg"]; ?>" />
                        </div>
