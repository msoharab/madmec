...
class Post extends BaseController {
    ...
    function __construct($para = false) {
        parent::__construct();
        $this->para = $para;
        $this->PostMod = new NewPost_Model();
        $this->PostMod->setPostData($this->postPara);
    }
    ...
    public function listWallPostComment() {
        if (isset($_SESSION["ListNewPost"]) && count($_SESSION["ListNewPost"]) > 0) {
            $this->baseview->listPost = $this->PostMod->listWallPost();
    ...
    public function likePost($param = false) {
        $this->baseview->setjsonData($this->PostMod->likePost($param));
        echo $this->baseview->renderJson();
    }
    public function disLikePost($param = false) {
        $this->baseview->setjsonData($this->PostMod->disLikePost($param));
        echo $this->baseview->renderJson();
    }
    public function changePostPreferences($param = false) {
        $this->baseview->setjsonData($this->PostMod->changePostPreferences());
        echo $this->baseview->renderJson();
    }
    public function reportPost($param = false) {
        $this->baseview->setjsonData($this->PostMod->reportPost());
        echo $this->baseview->renderJson();
    }
    public function subscribeChannel($param = false) {
        $this->baseview->setjsonData($this->PostMod->subscribeChannel());
        echo $this->baseview->renderJson();
    }
    public function addComment($param = false) {
        $this->baseview->setjsonData($this->PostMod->addComment($param));
        echo $this->baseview->renderJson();
    }
    public function likePostComment($param = false) {
        $this->baseview->setjsonData($this->PostMod->likePostComment($param));
        echo $this->baseview->renderJson();
    }
    public function disLikePostComment($param = false) {
        $this->baseview->setjsonData($this->PostMod->disLikePostComment($param));
        echo $this->baseview->renderJson();
    }
    public function changePostCommentPreferences($param = false) {
        $this->baseview->setjsonData($this->PostMod->changePostCommentPreferences());
        echo $this->baseview->renderJson();
    }
    public function addCommentReply($param = false) {
        $this->baseview->setjsonData($this->PostMod->addCommentReply($param));
        echo $this->baseview->renderJson();
    }
    public function likePostCommentReply($param = false) {
        $this->baseview->setjsonData($this->PostMod->likePostCommentReply($param));
        echo $this->baseview->renderJson();
    }
    public function disLikePostCommentReply($param = false) {
        $this->baseview->setjsonData($this->PostMod->disLikePostCommentReply($param));
        echo $this->baseview->renderJson();
    }
    public function changePostCommentReplyPreferences($param = false) {
        $this->baseview->setjsonData($this->PostMod->changePostCommentReplyPreferences());
        echo $this->baseview->renderJson();
    }
}
?>