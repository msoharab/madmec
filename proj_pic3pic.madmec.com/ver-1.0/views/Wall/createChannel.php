<?php
$create = (array) $this->idHolders["pic3pic"]["channel"]["create"];
?>
...
<div class="modal fade" id="<?php echo $create["parentDiv"]; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="" id="<?php echo $create["form"]; ?>" name="<?php echo $create["form"]; ?>" method="post" action="">
                <fieldset>
                    <div class="modal-body">
                        <div class="conatiner">
                            <div class="row">
                                <div class="col-lg-12"><h4>Name of the channel.</h4></div>
                                <div class="col-lg-12">
                                    <input type="text" class="form-control" name="<?php echo $create["name"]; ?>" placeholder="Channel name" aria-describedby="basic-addon1" id="<?php echo $create["name"]; ?>">
                                </div>
