...
<div class="container-fluid">
    ...
    <div class="channel-cover">
        <img src="<?php echo $this->config["URL"] . $this->config["VIEWS"]; ?>assets/img/channels/channel.jpg" class="img-responsive">
    </div>      
    <div class="col-md-2 col-sm-7 col-xs-7">
        <img src="<?php echo $this->config["URL"] . $this->config["VIEWS"]; ?>assets/img/channels/profile1.jpg" class="img-responsive img-thumbnail channel-profile">
    </div>      
    <br>
    <div class="col-md-1">        
        <a href="#" class="" > <i class="fa fa-thumbs-o-up thumbs-up fa-lg"></i> 23</a> Likes <span class="gap-right"></span>        
    </div>
...
<div class="col-lg-12 col-md-12 col-sm-12 colxs-12">
    <div id="exTab1" class=""> 
        <ul class="nav nav-tabs">
            ...
            <li>
                <a href="#2a" data-toggle="tab">Channel</a>
            </li>
            <li>
        ...
        <div class="tab-content clearfix">
            ...
            <div class="tab-pane active" id="1a"><br>
                <div id="exTab2" class=""> 
                    <ul class="nav nav-pills">
                        <li class="active">
                            <a  href="#1b" data-toggle="tab">Post</a>
                        </li>
                        <li>
                    ...
                    <div class="tab-content clearfix">
                        ...
                        <div class="tab-pane active" id="1b">
                            <div class="container"><br>
                                <div class="col-xs-12 col-sm-12 col-md-6" id="show-post" style="display:none;">&nbsp;</div>
                                <div class="col-xs-12 col-sm-12 col-md-6" id="hide-post">
                                    <div class="thumbnail">
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="target1" style="display:none;"><hr />
                                                    ...
                                                    <div class="col-md-3 pull-right text-right">
                                                        <button class="btn btn-danger btn-subscribe " data-toggle="modal" data-target="#postreport">
            ...
            <div class="tab-pane" id="2a"><br>
                <div class="col-lg-4">
                    <div class="list-group">
                        <a href="javascript:void();" class="list-group-item col-md-12 active">
                            <h4 class="list-group-item-heading col-md-6 align-left">Captain Channel</h4>
                        </a>
                        <a href="javascript:void();" class="list-group-item col-md-12 ">
                            <h4 class="list-group-item-heading col-md-6 align-left">CaptainChannel-1</h4>
                            <h5 class="list-group-item-heading col-md-6 align-right">Post</h5>
                        </a>
                        <a href="javascript:void();" class="list-group-item col-md-12 ">
                            <h4 class="list-group-item-heading col-md-6 align-left">CaptainChannel-2</h4>
                            <h5 class="list-group-item-heading col-md-6 align-right">Post</h5>
                        </a>
                        <a href="javascript:void();" class="list-group-item col-md-12 ">
                            <h4 class="list-group-item-heading col-md-6 align-left">CaptainChannel-3</h4>
                            <h5 class="list-group-item-heading col-md-6 align-right">Post</h5>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="list-group">
                        <a href="javascript:void();" class="list-group-item col-md-12 active">
                            <h4 class="list-group-item-heading col-md-6 align-left">Subscribed Channel</h4>
                        </a>
                        <a href="javascript:void();" class="list-group-item col-md-12 ">
                            <h4 class="list-group-item-heading col-md-6 align-left">SubscribedChannel-1</h4>
                            <h5 class="list-group-item-heading col-md-6 align-right">Post</h5>
                        </a>
                        <a href="javascript:void();" class="list-group-item col-md-12 ">
                            <h4 class="list-group-item-heading col-md-6 align-left">SubscribedChannel-2</h4>
                            <h5 class="list-group-item-heading col-md-6 align-right">Post</h5>
                        </a>
                    </div>
                </div>
        ...
        <div class="modal-content col-lg-12">
            ...
            <div class="row">
                ...
                <div class="input-group">
                    ...
                    <p class="wop">Harssing me in pic3pic</p>
                </div><!-- /input-group --> 
                <div class="input-group">
                    <span class="input-group-addon woborder">
                        <input type="radio" aria-label="..." name="ReportAbuse">
...
<!-- modal for post TAB report start-->
<div id="postreport" class="modal fade bs-example-modal-sm" tabindex="-2" role="dialog" aria-labelledby="mySmallModalLabel">
    <div class="modal-dialog modal-sm">
        <div class="modal-content col-lg-12">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
