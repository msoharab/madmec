<?php
$create = (array) $this->idHolders["pic3pic"]["channel"]["home"]["create"];
?>
            ...
            <form class="" 
                ...
                <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <input type="hidden" class="form-control" 
                                           id="<?php echo $create["channelID"]; ?>" 
                                           name="<?php echo $create["channelID"]; ?>"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="<?php echo $create["create"]; ?>" id="<?php echo $create["create"]; ?>" data-channel="<?php echo $this->ChannelId; ?>">Post</button>
                    </div>
                </fieldset>
            </form>
        </div>
