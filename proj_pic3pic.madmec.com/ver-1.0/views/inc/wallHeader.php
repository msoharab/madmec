...
$chSearch = isset($this->idHolders["pic3pic"]["header"]["channelSearch"]) ? (array) $this->idHolders["pic3pic"]["header"]["channelSearch"] : false;
?>
<!DOCTYPE html>
<html>
    <head>
		...
		<meta name="google-site-verification" content="LylbxB78-L8Tw-RT_QYKLSWPLTARjei9i-FePnFlouI" />
        <script src="<?php
                            ...
                            <?php if (isset($_SESSION["USERDATA"]["loggedin"]) && $_SESSION["USERDATA"]["loggedin"] == 1): ?>
                                <li class="gap-right sm-pad-top">
                                    <button type="button" onClick="sessionStorage.clear();
                                                window.location.href = '<?php echo $this->config["URL"] . $this->config["CTRL_4"]; ?>';" 
