...
<?php if ($this->UserId == $this->ChannelDetails["channel"]["chuid"]): ?>
    <div class="btn-group gap-right sm-pad-top">
        <button type="button"
                id="<?php echo $this->idHolders["pic3pic"]["channel"]["home"]["create"]["parentBut"]; ?>"
                name="<?php echo $this->idHolders["pic3pic"]["channel"]["home"]["create"]["parentBut"]; ?>"
                data-toggle="modal"
                data-target="#<?php echo $this->idHolders["pic3pic"]["channel"]["home"]["create"]["parentDiv"]; ?>"
                data-whatever="@mdo"
