...
$indipost = $this->idHolders["pic3pic"]["wall"]["list"]["indiView"];
?>
            ...
            <div class="row panel">
                    ...
                    <ul class="list-inline">
                        ...
                        <li  style="display:none;">
                            ...
                            if (isset($newRes[$i]["posts"]["chwaid"]) &&
                                    ...
                                    $newRes[$i]["posts"]["chsubid"] !== 0):
                                ?>
                                <a  id="<?php echo $listpost["subscription"]["id"] . $newRes[$i]["posts"]["id"]; ?>"
                                    title="Subscribe"
                                ...
                                <?php
                            elseif (isset($newRes[$i]["posts"]["chwaid"]) &&
                                    $newRes[$i]["posts"]["chwaid"] === 0 &&
                                    isset($newRes[$i]["posts"]["chsubid"]) &&
                                    $newRes[$i]["posts"]["chsubid"] === 0):
                                ?>
                ...
                <div class="row" id="comtarget<?php echo $i; ?>" style="display:none;">
                    ...
                    <div class="col-lg-12 pull-right"
                         id="<?php echo $listpost["comment"]["wall"]["parentDiv"] . $newRes[$i]["posts"]["id"]; ?>"
                         style="display:none;">
                        <section class="comment-list"
                                 id="<?php echo $listpost["comment"]["wall"]["outputDiv"] . $newRes[$i]["posts"]["id"]; ?>">
                                     <?php
