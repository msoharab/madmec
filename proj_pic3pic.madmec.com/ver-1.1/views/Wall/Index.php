    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-11 col-lg-11 col-xs-offset-0 col-md-offset-1">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5"
                 id="<?php echo $this->idHolders["pic3pic"]["wall"]["list"]["parentDiv"]; ?>"
                 style="border-right:solid 1px #E4D0D0;">
                <div class="channel-heading"><strong>Wall</strong></div>
                <div class="row" id="<?php echo $this->idHolders["pic3pic"]["wall"]["list"]["outputDiv"] ?>">
                    <?php
            ...
            <aside class="col-xs-12 col-md-3 border-left-lightgrey takemetop">
                <div class="list-group">
                    <button type="button"
                            id="<?php echo $this->idHolders["pic3pic"]["wall"]["create"]["parentBut"]; ?>"
                            name="<?php echo $this->idHolders["pic3pic"]["wall"]["create"]["parentBut"]; ?>"
                            data-toggle="modal"
                            data-target="#<?php echo $this->idHolders["pic3pic"]["wall"]["create"]["parentDiv"]; ?>"
                            data-whatever="@mdo"
