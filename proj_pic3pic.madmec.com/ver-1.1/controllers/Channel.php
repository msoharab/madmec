...
class Channel extends BaseController {
    ...
    public function filterListPost($id = false) {
        if ($id && is_string($id)) {
            /* Set list Post */
            $this->ChannelMod->ChannelId = (integer) $id;
            $this->ChannelMod->filterListPost();
    ...
    public function View($id = false) {
        if ($id && is_string($id)) {
            ...
            $this->baseview->ChannelSize = $this->ChannelDetails["channel_size"];
            $this->ChannelMod->ChannelId = $this->ChannelId;
            $this->ChannelMod->ChannelDetails = $this->ChannelDetails;
            $this->ChannelMod->ChannelSize = $this->ChannelDetails["channel_size"];
            $this->Index();
        } else {
            $this->gotoWall();
        }
    ...
    public function updateChannelAdv($id = false) {
        if ($id && is_string($id)) {
            $this->ChannelMod->ChannelId = (integer) $id;
            $this->baseview->setjsonData($this->ChannelMod->ChannelAdv());
            echo $this->baseview->renderJson();
        }
    }
