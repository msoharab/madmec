    ...
    public function forgotPassword($param) {
        ...
        if (isset($_SESSION["PASSWD"]["logindata"])) {
            $message = '<table width="80%" border="0" align="center" cellpadding="3" cellspacing="3">
                <td align="center"><p><span style="font-weight:900; font-size:24px;  color:#999;">Pic3Pic Account details.</span></p></td>
                <td colspan="2">&nbsp;</td>
                <tr>
                ...
                <tr>
                <td colspan="2"><p>You received this email because you are the user of pic3pic.</p></td>
                </tr>
                <tr>
                <td colspan="2">Regards,<br />Pic3Pic</td>
                </tr>
                <tr>
