        var OUTPUT='#output';
        var URL='http://aimim-members.in/';
        var ADMINURL='http://aimim-members.in/admin/';
        var AJAXURL= URL+"admin/control.php";
        var LAND_PAGE = URL+"admin/admin.php";
	...
	var deci_reg=/^(-?)[0-9]+\.[0-9]$/;
        ...
        var WELCOME_MODULE=URL+'/inc/modules/welcome.html';
        var VIEWMEMBER_MODULE=URL+'/inc/modules/viewmember.html';
        var ADMINADDMEMBER_MODULE=URL+'/inc/modules/adminaddmemeber.html';
        var MESSAGE_MODULE=URL+'/inc/modules/message.html';
        var LOGOUT_MODULE=URL+'/inc/modules/logout.html';
