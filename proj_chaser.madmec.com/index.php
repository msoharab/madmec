...
<META HTTP-EQUIV="Refresh" CONTENT="0;URL=scriptdisable.html">
    ...
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><b>Chaser</b>Ver 1.0</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
        <ul class="nav nav-tabs">
            <li class="active"><a href="#SignIn" data-toggle="tab" id="SignInBut">SignIn</a></li>
            <li><a href="#Register" data-toggle="tab" id="RegisterBut">Register</a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane fade in active panel panel-warning" id="SignIn">
            ...
            <div class="tab-pane fade panel panel-warning" id="Register">
                <div class="panel-heading"><h4><strong><i class="fa fa-user"></i> Employee Registration</strong></h4></div>
                <div class="panel-body">
                    <fieldset id="custregform">
                        <div class="form-group">
                            <div class="input-group input-group-lg">
                                <span class="input-group-addon text-warning" id="cust_nmmsg"><i class="fa fa-user fa-fw"></i></span>
                        ...
                        <button type="button" id="custregformBut" class="btn btn-warning btn-block"><i class="fa fa-upload fa-x2 fa-fw"></i>&nbsp;Register</button>
                    </fieldset>
                </div>
