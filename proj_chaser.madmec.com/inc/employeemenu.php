                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-body">
                                        <div class="col-xs-4 text-center">
                                            <a class="extra-menu1" id="#dahboard" href="javascript:void(0)">Dashboard</a>
                                        </div>
                                        <div class="col-xs-4 text-center">
                                            <a class="extra-menu2" id="#engage" href="javascript:void(0)">Engage</a>
                                        </div>
                                        <div class="col-xs-4 text-center">
                                            <a class="extra-menu3"id="#import" href="javascript:void(0)">Import</a>
                                        </div>
                                    </li>
                                    <!-- Menu Footer-->
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="javascript:void(0)" id="activity">
                                <i class="fa fa-gears"></i> <span>Activity</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" id="engage" class="extra-menu2">
                                <i class="fa fa-lock"></i> <span>Engage</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" id="import" class="extra-menu3">
