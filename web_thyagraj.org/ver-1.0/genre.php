...
<tr>
	<td>Name:</td>
	<td class="textspace"></td>
	<td><input type="text" class="form-control" name="genre" value="<?php echo $genre; ?>" maxlength="255" class="edit"></td>
</tr>
<tr>
	<td>Parent:</td>
	<td class="textspace"></td>
...
<tr>
	<td>Name:</td>
	<td class="textspace"></td>
	<td><input type="text" class="form-control" name="genre" maxlength="255" class="edit"></td>
</tr>
<tr>
	<td>Parent:</td>
	<td class="textspace"></td>
...
<form action="genre.php" method="post" id="genreform">
	...
	<input type="hidden" name="sign" value="<?php echo $cfg['sign']; ?>">
<table class="table table-striped"><tr><td><!-- table tab wrapper -->
<ul id="tab">
