...
$cfg['mysqli_db']                   = 'thyagraj';
$cfg['mysqli_user']                 = 'root';
$cfg['mysqli_password']             = 'madmec@418133';
...
//  | Windows:        'D:/Music/';                                           |
//  +------------------------------------------------------------------------+
$cfg['media_dir']                   = '/opt/lampp/server/library/web_thyagraj.org/mp3files';
...
$cfg['search_url_artist'][]         = 'http://www.discogs.com/search/?q=%artist&type=artist';
$cfg['search_url_album'][]          = 'http://www.discogs.com/search/?q=%album&type=release';
$cfg['search_url_combined'][]       = '';
$cfg['search_method'][]             = 'get';
$cfg['search_charset'][]            = 'UTF-8';
...
$cfg['search_url_artist'][]         = 'https://www.muziekweb.nl/Muziekweb/Cat/Search/Pop?artist=%artist';
$cfg['search_url_album'][]          = 'https://www.muziekweb.nl/Muziekweb/Cat/Search/Pop?album=%album';
$cfg['search_url_combined'][]       = 'https://www.muziekweb.nl/Muziekweb/Cat/Search/Pop?artist=%artist&album=%album';
$cfg['search_method'][]             = 'get';
$cfg['search_charset'][]            = 'UTF-8';
...
$cfg['search_name'][]               = 'Spotify';
$cfg['search_url_artist'][]         = 'https://play.spotify.com/search/%artist%3Aartists';
$cfg['search_url_album'][]          = 'https://play.spotify.com/search/%album%3Aalbums';
$cfg['search_url_combined'][]       = '';
$cfg['search_method'][]             = 'get';
$cfg['search_charset'][]            = 'UTF-8';
