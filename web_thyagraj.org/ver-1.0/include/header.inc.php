...
//  | Head                                                                   |
//  +------------------------------------------------------------------------+
$header['title'] = 'Thyagraj.com &bull; ';
...
$header['head'] .= "\t" . '<meta name="application-name" content="netjukebox ' . html(NJB_VERSION) . ', Copyright ' . html_entity_decode('&copy;', null, NJB_DEFAULT_CHARSET) . ' 2001-2016 Willem Bartels">' . "\n";
...
//  | Submenu                                                                |
//  +------------------------------------------------------------------------+
$header['submenu'] = '<ul class="dropdown-menu scrollable-menu" role="menu">' . "\n";
if ($cfg['menu'] == 'media') {
...
//  | Menu                                                                   |
//  +------------------------------------------------------------------------+
$header['menu'] = '<ul class="nav navbar-nav">' . "\n";
$header['menu'] .= "\t" . '<li class="' . ($cfg['menu'] == 'media' ? '' : '') . '"><a href="index.php"><i class="ion-music-note"></i>&nbsp;Media</a></li>' . "\n";
$header['menu'] .= "\t" . '<li class="' . ($cfg['menu'] == 'favorite' ? '' : '') . '"><a href="favorite.php"><i class="ion-android-favorite"></i>&nbsp;Favorites</a></li>' . "\n";
$header['menu'] .= "\t" . '<li class="' . ($cfg['menu'] == 'playlist' ? '' : '') . '"><a href="playlist.php"><i class="fa fa-list-alt"></i>&nbsp;Playlist</a></li>' . "\n";
$header['menu'] .= "\t" . '<li class="' . ($cfg['menu'] == 'config' ? '' : '') . '"><a href="config.php"><i class="fa fa-gears"></i>&nbsp;Setting</a></li>' . "\n";
$header['menu'] .= "\t" . '<li class="dropdown"><a aria-expanded="false" href="#" class="dropdown-toggle" data-toggle="dropdown">More..<span class="caret"></span></a>' . "\n";
$header['menu'] .= "\t" . $header['submenu']. "\n";
$header['menu'] .= "\t" . '</li>' . "\n";
$header['menu'] .= "\t" . '<li class="' . ($cfg['menu'] == 'config' ? '' : '') . '"><a href="index.php?authenticate=logout">Logout: ' . html($cfg['username']) . '</a></li>' . "\n";
$header['menu'] .= '</ul>' . "\n";
