...
<tr>
	<td>Name:</td>
	<td class="textspace"></td>
	<td><input type="text" class="form-control" name="name" value="<?php echo html($cfg['player_name']); ?>" maxlength="255" class="edit"></td>
</tr>
...
<tr>
	<td>Player host:</td>
	<td></td>
	<td><input type="text" class="form-control" name="player_host" value="<?php echo html($cfg['player_host']); ?>" maxlength="255" class="short"></td>
</tr>
<tr>
	<td>Player port:</td>
	<td></td>
	<td><input type="text" class="form-control" name="player_port" value="<?php echo $cfg['player_port']; ?>" maxlength="5" class="short"></td>
</tr>
<tr>
	<td>Player password:</td>
	<td></td>
	<td><input type="password" class="form-control" name="player_pass" value="<?php echo html($cfg['player_pass']); ?>" maxlength="255" class="short"></td>
</tr>
<tr>
	<td>Media share:</td>
	<td></td>
	<td><input type="text" class="form-control" name="media_share" value="<?php echo html($cfg['media_share']); ?>" maxlength="255" class="short"></td>
</tr>
...
<tr class="odd">
	...
	<td>Image link:</td>
	<td></td>
	<td><input type="text" class="form-control" value="<?php echo $url; ?>" readonly class="edit" onclick="focus(this); select(this);"></td>
	<td></td>
</tr>
<tr class="even">
	<td></td>
	<td>HTML code:</td>
	<td class="textspace"></td>
	<td><input type="text" class="form-control" value="<?php echo html($html); ?>" readonly class="edit" onclick="focus(this); select(this);"></td>
	<td></td>
</tr>
<tr class="odd">
	<td></td>
	<td>Forum BBCode:</td>
	<td class="textspace"></td>
	<td><input type="text" class="form-control" value="<?php echo html($bbcode); ?>" readonly class="edit" onclick="focus(this); select(this);"></td>
	<td></td>
</tr>
</table>
<?php
