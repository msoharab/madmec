...
function cliUpdate() {
	...
	echo 'netjukebox ' . NJB_VERSION . ', Copyright (C) 2001-2016 Willem Bartels' . "\n";
...
<tr class="footer">
	...
	<tr class="footer">
		...
		<td>Artist:</td>
		<td class="space"></td>
		<td><input type="text" class="form-control" name="artist" value="<?php echo html($artistSearch); ?>" class="edit"></td>
...
<?php
	...
	<tr class="footer">
		...
		<td>Album:</td>
		<td></td>
		<td><input type="text" class="form-control" name="album" value="<?php echo html($albumSearch); ?>" class="edit"></td>
		<td></td>
...
<tr class="odd">
	...
	<td>Front cover:</td>
	<td class="textspace"></td>
	<td><input type="file" class="form-control" name="image_front"></td>
	<td class="space"></td>
</tr>
<tr class="even">
	<td class="space"></td>
	<td>Back cover:</td>
	<td class="textspace"></td>
	<td><input type="file" class="form-control" name="image_back"></td>
	<td class="space"></td>
</tr>
</table>
