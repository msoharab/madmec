...
<?php
	...
	while ($favorite = mysqli_fetch_assoc($query)) {
		if ($previous_stream != $favorite['stream'] && $i > 0) {
			$i = 0;
			echo '<tr><td colspan="4"></td><td colspan="2">Radio</td><td colspan="5">Comment</td></tr>' . "\n";
		} ?>
<tr class="<?php echo ($i++ & 1) ? 'even' : 'odd'; ?> mouseover">
	<td></td>
...
<tr>
	<td>Name:</td>
	<td class="textspace"></td>
	<td><input type="text" class="form-control" name="name" value="<?php echo html($favorite['name']); ?>" maxlength="255" class="edit"></td>
</tr>
<tr>
	<td>Comment:</td>
	<td></td>
	<td><input type="text" class="form-control" name="comment" value="<?php echo html($favorite['comment']); ?>" maxlength="255" class="edit" <?php echo bbcodeReferenceTitle(); ?>></td>
</tr>
...
<tr>
	...
	<td></td>
	<td><input type="text" class="form-control" name="stream_url" value="" maxlength="255" class="edit"></td>
</tr>
<tr>
	<td>Playlist url (m3u, pls):</td>
	<td></td>
	<td><input type="text" class="form-control" name="playlist_url" value="" maxlength="255" class="edit"></td>
</tr>
<tr class="space"><td colspan="3"></td></tr>		
<tr>
	<td></td>
