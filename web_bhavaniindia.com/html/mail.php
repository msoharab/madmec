            ...
            <div class="agileinfo_mail_grids">
                <div class="col-md-4 agileinfo_mail_grid_left">
                    <ul>
                        ...
                        <li>address<span><h4># 92 1st R BLOCK 20th 'B'<br>MAIN ROAD RAJAJINAGAR<br>(NEAR MAHALAXMI METRO STATION)<br> Bangalore 560010</h4><br></span></li>
                    </ul>
                    <ul>
                        <li><i class="fa fa-envelope" aria-hidden="true"></i></li>
                        <li>email<span><a href="mailto:bhavanivittal1997@gmail.com">bhavanivittal1997@gmail.com</a></span>
                                 <span><a href="mailto:bhavanienterprise.info@gmail.com">bhavanienterprise.info@gmail.com</a></span></li>
                    </ul>
                    <ul>
                        <li><i class="fa fa-phone" aria-hidden="true"></i></li>
                        <li>call to us<span>(080) 28063600</span></li>
                    </ul>
                </div>
