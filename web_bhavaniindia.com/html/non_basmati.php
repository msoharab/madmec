            ...
            <div class="w3l_banner">
                ...
                <div class="services">
                    ...
                    <div class="w3ls_service_grids">
                        ...
                        <div class="col-md-5 col-sm-offset-1 wow fadeInLeftBig text-primary text-justify animated w3ls_service_grid_left" style="animation-name: fadeInLeftBig;">
                            ...
                            <p>Non Basmati Rice is gaining high popularity due to its long grain size and tempting aroma.
                                ...
                                In order to provide stone and husk free Parmal White Non Basmati Rice.</p>
                        </div>
                    </div>
                    ...
                    <div class="fresh-vegetables">
						...
						<!--<h3>Bottom Products</h3>-->
						<div class="container">
							<div class="w3l_banner_nav_right_banner3_btm text-justify">
								<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
									<div class="view view-tenth">
										<img src="<?php echo URL . ASSET_IMG; ?>58.jpg" alt=" " class="img-responsive" />
										<div class="mask">
											<h4>Raw Rice</h4>
											<p> Raw Rice is good source of energy and rich in protein .  It can be grained to make different types of dishes etc</p>
										</div>
									</div>
								...
								<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
									...
									<div class="view view-tenth">
										<img src="<?php echo URL . ASSET_IMG; ?>36.jpg" alt=" " class="img-responsive" />
										<div class="mask">
											<h4>Boiled Rice</h4>
