            ...
            <div class="container">
                ...
                <div class="w3ls_logo_products_left1">
                    <ul class="special_items">
                        ...
                        <li class="dropdown"><a href="<?php echo URL; ?>products.php" class="dropdown-toggle" data-toggle="dropdown">Products<span class="caret"></span></a><i></i>
                            <div class="w3ls_vegetables">
                                <ul class="dropdown-menu drp-mnu1">
                                    <li><a href="non_basmati.php">Non Basmati</a></li>
                                    <li><a href="sona_masoori.php">Sona Masuri</a></li>
                                    <li><a href="lachkari.php">   Lachkari   </a></li>
                                </ul>
                            </div>
                        </li>
