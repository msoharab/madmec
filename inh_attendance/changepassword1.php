...
<?php		
	...
	while ( $row = mysql_fetch_array($recordset) )
	{
		    ...
		    {
		         header("Location:changepassword.php?invalid=1&old=".$old."&new=".$new."&confirm=".$confirm);
			  	 exit;
		    }
			if ( $_POST["new"] == "" && $_POST["confirm"] == "" )
			{
		         header("Location:changepassword.php?invalid=3&old=".$old."&new=".$new."&confirm=".$confirm);
				 exit;
		    }
		    if ( $_POST["new"] <> $confirm )
		    {
		         header("Location:changepassword.php?invalid=2&old=".$old."&new=".$new."&confirm=".$confirm);
				 exit;
		    }							 		   				           		    
	 }	   
...
<body bgcolor="#f2f2f2">
<form name="form1" method="post" action="changepassword1.php?uid=<?=$uid?>">
				...
				<td colspan="2">
					...
					<!-- fwtable fwsrc="sub.png" fwbase="user.jpg" fwstyle="Dreamweaver" fwdocid = "255186328" fwnested="0" -->
					  ...
					  <tr>
					   ...
					   <td><a href="aureports.php?uid=<?=$uid?>"><img name="user_r2_c12" src="images/user_r2_c12.jpg" width="28" height="45" border="0" alt=""></a></td>
				...
				<td valign="top"><br>
								...
								<?php	   
						            ...
						            while ( $row = mysql_fetch_array($recordset) )
						            {
								            ...
								            $af = mysql_query($query,$connection);
								            if ( $af >= 1)
								            {
