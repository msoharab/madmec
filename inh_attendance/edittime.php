...
<script>
	 function saveinfo() {
		//date1 = form1.textfield1.value;
		//day1 = form1.textfield2.value;
		//timein = form1.textfield3.value;	
		
		form1.action = "updatetime.php?uid=<?php echo $uid?>&user=<?php echo $user?>&pid=<?php echo $pid?>";
		form1.submit();
	  }
	function cancel() {
	form1.action ="aureports.php?can=1&uid=<?php echo $uid?>&cuser=<?php echo $user?>";
	form1.submit();
	}
</script>
<style>
				...
				<td align="left" valign="top">
					<table width="160" cellpadding="0" cellspacing="0">
						<tr>
						  ...
						  <tr>
						   <td colspan="4" valign="top"><a href="aureports.php?uid=<?=$uid?>"><img name="sub_r7_c2" src="images/sub_r7_c2.jpg" width="139" height="30" border="0" alt=""></a></td>
						   <td rowspan="3">&nbsp;</td>
						   <td><img src="images/spacer.gif" width="1" height="30" border="0" alt=""></td>
						  </tr>
						  <tr>
						   <td colspan="5" valign="top"><a href="user.php?uid=<?=$uid?>"><img name="user_r6_c2" src="images/user_r6_c2.jpg" width="160" height="31" border="0" alt=""></a></td>
					...
					<table width="100%" cellpadding="0" cellspacing="0">
							<tr>
								...
								<br><table border="1">
									...
									<tr>
									<td>User </td>
									<td><input type="text" name="textfield5" size="15" readonly></td></tr>
									<td>Date </td>
									<td><input type="text" name="textfield1" size="15" readonly></td></tr>
									<tr><td>Day</td>
									<td><input type="text" name="textfield2" size="15" readonly></td></tr>
									<tr><td>Time In</td>
									<td><input type="text" name="textfield3" size="15"></td></tr>
									<tr><td>Time Out</td>
									<td><input type="text" name="textfield4" size="15"></td></tr>
									<tr><td></td>
									<td><input type="button" name="button1" value="Update " onClick="saveinfo()" >
									<input type="button" name="button1" value="Cancel" onClick="cancel()"></td></tr>
									</table>
									<?php 
											$recordset3 = mysql_query("select * from presence where pid=".$pid);
											while($record3 = mysql_fetch_array($recordset3)){
											echo"<script> form1.textfield1.value = '".$record3["date"]."';
											form1.textfield2.value = '".$record3["pday"]."';
											form1.textfield3.value = '".$record3["timein"]."';
											form1.textfield4.value = '".$record3["timeout"]."';
											</script>";
											}
											$recordset4 = mysql_query("select * from users where uid=".$user);
											while($record4 = mysql_fetch_array($recordset4)){
											echo"<script> 
											form1.textfield5.value = '".$record4["ulogin"]."';
											</script>";
											}
									?>
