...
<script>
function saveinfo() {
			form1.action = "updategroup.php?uid=<?php echo $uid?>&gid=<?php echo $gid?>";
			form1.submit();
	}
function cancel() {
	form1.action ="groups.php?uid=<?php echo $uid?>";
	form1.submit();
	}
</script>
<style>
			...
			<tr>
				...
				<td valign="top"><br>
					<br><table border="1">
						...
						<tr><td>Group Name</td>
						<td>
						<input type="text" name="textfield1" size="10" readonly>
						</td></tr>
						...
						<tr><td align="center">
						<input type="button" name="button1" value="Update" onClick="saveinfo()">
						</td>
						<td align="center">
						...
						<?php 
								$recordset = mysql_query("select * from groups where gid=".$gid);
								while($record = mysql_fetch_array($recordset)){
								echo"<script>form1.textfield1.value = '",$record["gname"],"';
								form1.textfield2.value ='",$record["absentfine"],"';
								form1.textfield3.value ='",$record["hoursfine"],"';
								</script>";
								}
						?>
						</form>
