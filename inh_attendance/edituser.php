...
<script>
	function saveinfo() {
		...
		return;
			...
			form1.action = "update.php?uid=<?php echo $uid?>&user=<?php echo $user?>";
			form1.submit();
	}
	function cancel() {
...
<td><select name="select1">
						<?php 
						$recordset = mysql_query ("select * from designation order by did");
...
<td><input type="text" name="textfield4" size="8" value="0"></td></tr>
						<tr><td></td>
						...
						<?php 
							if($_GET["action"]==1){
								...
								echo"<script> form1.textfield1.value = '".$record3["ulogin"]."';
								form1.textfield2.value = '".$record3["upassword"]."';
								form1.textfield3.value = '".$record3["utype"]."';
								form1.textfield4.value = '".$record3["uwhours"]."';
								for(i=0; i< form1.select1.length; i++) {
									if(form1.select1.options[i].text =='".$record3["udesignation"]."') {
									form1.select1.options[i].selected = true;
									} 
								}
								for(j=0; j< form1.select2.length; j++) {
									if(form1.select2.options[j].text =='".$record3["ugroup"]."') {
									form1.select2.options[j].selected = true;
									}
								}
								for(k=0; k< form1.select3.length; k++) {
									if(form1.select3.options[k].text =='".$record3["uteam"]."') {
