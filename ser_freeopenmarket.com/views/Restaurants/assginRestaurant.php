<?php
$gymAss = isset($this->idHolders["onlinefood"]["restaurant"]["AssignRestaurant"]) ? (array) $this->idHolders["onlinefood"]["restaurant"]["AssignRestaurant"] : false;
?>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><strong> Assign Restaurant</strong></h3>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <select class="form-control"
                                    ...
                                    data-rules='{"required": true}'
                                    data-messages='{"required": "Select Restaurant"}'>
                            </select>
                        </div>
                    </div>
                    <div class="row">
