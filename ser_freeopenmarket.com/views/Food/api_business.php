<?php
$apiBusiness = isset($this->idHolders["onlinefood"]["api"]["ApiBusiness"]) ? (array) $this->idHolders["onlinefood"]["api"]["ApiBusiness"] : false;
?>
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="add">
                            <?php
                            require_once 'api_business_form.php';
                            ?>
                        </div>
                        <div class="tab-pane" id="list">
                            <?php
                            require_once 'api_business_list.php';
                            ?>
                        </div>
                    </div>
                </div>
