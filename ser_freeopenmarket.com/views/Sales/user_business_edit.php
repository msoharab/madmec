<?php
$userBusi = isset($this->idHolders["onlinefood"]["gateway"]["EditBusiness"]) ? (array) $this->idHolders["onlinefood"]["gateway"]["EditBusiness"] : false;
?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input class="form-control"
                                                               ...
                                                               data-messages='{"required": "Enter Website","minlength": "Length Should be minimum 10 Characters"}'
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control"
                                                               ...
                                                               value="<?php echo trim($this->getuserDet["data"]["users_bank_ac_name"]); ?>"
                                                               data-rules='{"required": true,"minlength": "3"}'
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input class="form-control"
                                                               ...
                                                               data-rules='{"required": true,"minlength": "3"}'
                                                               data-messages='{"required": "Enter the Branch Name","minlength": "Length Should be minimum 3 numbers"}'
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input class="form-control"
                                                               ...
                                                               data-messages='{"required": "Enter the Branch Code","minlength": "Length Should be minimum 2 numbers"}'
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control"
                                                                  ...
                                                                  placeholder="Address Line"><?php echo trim($this->getuserDet["data"]["users_business_address_addressline"]); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
