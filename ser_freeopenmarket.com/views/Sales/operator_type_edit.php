<?php
$optype = isset($this->idHolders["onlinefood"]["gateway"]["EditOperatorType"]) ? (array) $this->idHolders["onlinefood"]["gateway"]["EditOperatorType"] : false;
?>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <input type="hidden"
                                   ...
                                   data-rules='{}'
                                   data-messages='{}'
                                   value="<?php echo base64_encode($this->getuserDet["data"]["gateway_operator_type_id"]); ?>" />
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input  type="text"
                                                ...
                                                value="<?php echo trim($this->getuserDet["data"]["gateway_operator_type_type"]); ?>"
                                    ...
                                    <div class="col-sm-5">
                                        <input  type="text"
                                                ...
                                                value="<?php echo trim($this->getuserDet["data"]["gateway_operator_type_lt_code"]); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text"
                                               ...
                                               value="<?php echo trim($this->getuserDet["data"]["gateway_operator_type_commission_fixed"]); ?>"
                                               data-rules='{"required": true}'
                                    ...
                                    <div class="col-sm-5">
                                        <input  type="text"
                                                ...
                                                value="<?php echo trim($this->getuserDet["data"]["gateway_operator_type_commission_variable"]); ?>"
                                                data-rules='{"required": true}'
                            ...
                            <div class="col-sm-12 form-group">
                                <div class="text-center">
                                    <button type="submit"
                                            ...
                                            data-rules='{}'
                                            data-messages='{}'
                                            class="btn btn-danger">Update Operator Type</button>
                                </div>
                            </div>
                        </div>
                    </div>
