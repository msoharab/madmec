<?php
$userFixComm = isset($this->idHolders["onlinefood"]["user"]["Commission"]["FixedCommission"]) ? (array) $this->idHolders["onlinefood"]["user"]["Commission"]["FixedCommission"] : false;
$userVarComm = isset($this->idHolders["onlinefood"]["user"]["Commission"]["ViariableCommission"]) ? (array) $this->idHolders["onlinefood"]["user"]["Commission"]["ViariableCommission"] : false;
$userCommList = isset($this->idHolders["onlinefood"]["user"]["Commission"]["ListCommission"]) ? (array) $this->idHolders["onlinefood"]["user"]["Commission"]["ListCommission"] : false;
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> User Commission </li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#setfixed" data-toggle="tab">Flat Commission</a></li>
                    ...
                    <div class="tab-content">
                        <div class="active tab-pane" id="setfixed">
                            ...
                            <form class="form-horizontal"
                                  action=""
                                  id="<?php echo $userFixComm["form"]; ?>"
                                  name="<?php echo $userFixComm["form"]; ?>"
                                  method="post">
                                <div class="form-group">
                                    <label for="inputName" class="col-sm-2 control-label">Service</label>
                                    <div class="col-sm-10">
                                        <select class="form-control"
                                                id="<?php echo $userFixComm["fields"][0]; ?>"
                                                name="<?php echo $userFixComm["fields"][0]; ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control"
                                                id="<?php echo $userFixComm["fields"][1]; ?>"
                                                name="<?php echo $userFixComm["fields"][1]; ?>"
                                                data-rules='{"required": true}'
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number"
                                               class="form-control"
                                               id="<?php echo $userFixComm["fields"][2]; ?>"
                                               name="<?php echo $userFixComm["fields"][2]; ?>"
                                               data-rules='{"required": true}'
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number"
                                               class="form-control"
                                               id="<?php echo $userFixComm["fields"][3]; ?>"
                                               name="<?php echo $userFixComm["fields"][3]; ?>"
                                               data-rules='{"required": true}'
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="submit"
                                                id="<?php echo $userFixComm["fields"][4]; ?>"
                                                name="<?php echo $userFixComm["fields"][4]; ?>"
                                                data-rules='{}'
                                                data-messages='{}'
                                            ...
                                            <div class="col-xs-12">
                                                <div class="box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select class="form-control"
                                                                    id="<?php echo $userCommList["fields"][0]; ?>"
                                                                    name="<?php echo $userCommList["fields"][0]; ?>"
                                                                    data-rules='{"required": true}'
                                                                    data-messages='{"required": "Select Gateway"}'>
                                                                <option>ALL </option>
                                                                <option>Oniline Food Order</option>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-1 col-sm-10">
                                                            <button type="submit"
                                                                    id="<?php echo $userCommList["fields"][1]; ?>"
                                                                    name="<?php echo $userCommList["fields"][1]; ?>"
                                                                    data-rules='{}'
                                                                    data-messages='{}'
                                                    ...
                                                    <div class="box-body table-responsive">
                                                        <table id="<?php echo $userCommList["fields"][0]; ?>"class="table table-bordered table-striped">
                                                            <thead>
                                                                <tr>
                                                                    <th>Service</th>
                                                                    <th>Gateway</th>
