<?php
$ops = isset($this->idHolders["recharge"]["masterdata"]["EditOperator"]) ? (array) $this->idHolders["recharge"]["masterdata"]["EditOperator"] : false;
?>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <input type="hidden"
                                       ...
                                       data-rules='{}'
                                       data-messages='{}'
                                       value="<?php echo base64_encode($this->getuserDet["data"]["operator_id"]); ?>" />
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input  type="text"
                                                    ...
                                                    value="<?php echo trim($this->getuserDet["data"]["operator_name"]); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input  type="text"
                                                    ...
                                                    value="<?php echo trim($this->getuserDet["data"]["operator_lt_code"]); ?>"
                                        ...
                                        <div class="col-sm-5">
                                            <input  type="text"
                                                    ...
                                                    value="<?php echo trim($this->getuserDet["data"]["operator_alias"]); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text"
                                                   ...
                                                   value="<?php echo trim($this->getuserDet["data"]["operator_commission_fixed"]); ?>"
                                                   data-rules='{"required": true}'
                                        ...
                                        <div class="col-sm-5">
                                            <input  type="text"
                                                    ...
                                                    value="<?php echo trim($this->getuserDet["data"]["operator_commission_variable"]); ?>"
                                                    data-rules='{"required": true}'
