<?php
$UsrPrEdit = isset($this->idHolders["recharge"]["masterdata"]["EditMOS"]) ? (array) $this->idHolders["recharge"]["masterdata"]["EditMOS"] : false;
?>
                                        ...
                                        <div class="box">
                                            <div class="box-body">
                                                <input type="hidden"
                                                       ...
                                                       data-rules='{}'
                                                       data-messages='{}'
                                                       value="<?php echo base64_encode($this->getuserDet["data"]["portal_mode_of_services_id"]); ?>" />
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input class="form-control"
                                                                   ...
                                                                   value="<?php echo trim($this->getuserDet["data"]["portal_mode_of_services_mos"]); ?>"
