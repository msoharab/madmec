...
<form class="form-horizontal"
      action=""
      id="<?php echo $apiBusi["form"]; ?>"
      name="<?php echo $apiBusi["form"]; ?>"
      method="post">
    <div class="content">
                        ...
                        <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control"
                                                id="<?php echo $apiBusi["fields"][25]; ?>"
                                                name="<?php echo $apiBusi["fields"][25]; ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][0]; ?>"
                                               name="<?php echo $apiBusi["fields"][0]; ?>"
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][24]; ?>"
                                               name="<?php echo $apiBusi["fields"][24]; ?>"
                                               data-rules='{"required": true}'
                                               data-messages='{"required": "Enter Business Established"}'
                                               readonly="readonly"
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][1]; ?>"
                                               name="<?php echo $apiBusi["fields"][1]; ?>"
                                               data-rules='{"required": true,"minlength": "3"}'
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][2]; ?>"
                                               name="<?php echo $apiBusi["fields"][2]; ?>"
                        ...
                        <div class="box-body">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][3]; ?>"
                                               name="<?php echo $apiBusi["fields"][3]; ?>"
                                               data-rules='{"required": true,"minlength": "3"}'
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][4]; ?>"
                                               name="<?php echo $apiBusi["fields"][4]; ?>"
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][5]; ?>"
                                               name="<?php echo $apiBusi["fields"][5]; ?>"
                                               data-rules='{"required": true,"minlength": "3"}'
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][6]; ?>"
                                               name="<?php echo $apiBusi["fields"][6]; ?>"
                                               data-rules='{"required": true,"minlength": "3"}'
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control" 
                                               id="<?php echo $apiBusi["fields"][7]; ?>"
                                               name="<?php echo $apiBusi["fields"][7]; ?>"
                                               data-rules='{"required": true,"minlength": "3"}'
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][8]; ?>"
                                               name="<?php echo $apiBusi["fields"][8]; ?>"
                                               data-rules='{"required": true,"minlength": "3"}'
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][9]; ?>"
                                               name="<?php echo $apiBusi["fields"][9]; ?>"
                        ...
                        <div class="box-body" id="addbox">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control"
                                                  id="<?php echo $apiBusi["fields"][10]; ?>"
                                                  name="<?php echo $apiBusi["fields"][10]; ?>"
                                                  data-rules='{"required": true}'
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][11]; ?>"
                                               name="<?php echo $apiBusi["fields"][11]; ?>"
                                               data-rules='{"required": true}'
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][12]; ?>"
                                               name="<?php echo $apiBusi["fields"][12]; ?>"
                                               data-rules='{"required": true}'
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][13]; ?>"
                                               name="<?php echo $apiBusi["fields"][13]; ?>"
                                               data-rules='{"required": true}'
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][14]; ?>"
                                               name="<?php echo $apiBusi["fields"][14]; ?>"
                                               data-rules='{"required": true}'
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][15]; ?>"
                                               name="<?php echo $apiBusi["fields"][15]; ?>"
                                               data-rules='{"required": true}'
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][16]; ?>"
                                               name="<?php echo $apiBusi["fields"][16]; ?>"
                                               data-rules='{"required": true,"minlength": "3"}'
                        ...
                        <div class="box-body">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][17]; ?>"
                                               name="<?php echo $apiBusi["fields"][17]; ?>"
                                               data-rules='{"required": true,"minlength": "3"}'
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                    <select class="form-control"
                                            id="<?php echo $apiBusi["fields"][18]; ?>"
                                            name="<?php echo $apiBusi["fields"][18]; ?>"
                                            data-rules='{"required": true}'
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][19]; ?>"
                                               name="<?php echo $apiBusi["fields"][19]; ?>"
                                               data-rules='{"required": true}'
                        ...
                        <div class="box-body">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][20]; ?>"
                                               name="<?php echo $apiBusi["fields"][20]; ?>"
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                    <select class="form-control"
                                            id="<?php echo $apiBusi["fields"][21]; ?>"
                                            name="<?php echo $apiBusi["fields"][21]; ?>"
                                            data-rules='{"required": true}'
                                            data-messages='{"required": "Select Document type"}'>
                                    </select>
                                </div>
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control"
                                               id="<?php echo $apiBusi["fields"][22]; ?>"
                                               name="<?php echo $apiBusi["fields"][22]; ?>"
                                               data-rules='{"required": true}'
                                               data-messages='{"required": "Upload valid document"}'
                                               type="file">
                                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-5 col-sm-10">
                            <button type="submit"
                                    ...
                                    id="<?php echo $apiBusi["fields"][23]; ?>"
                                    name="<?php echo $apiBusi["fields"][23]; ?>"
                                    data-rules='{}'
