...
<form class="form-horizontal"
      action=""
      id="<?php echo $apiPers["form"]; ?>"
      name="<?php echo $apiPers["form"]; ?>"
      method="post">
    <div class="content">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text"
                                                   class="form-control"
                                                   id="<?php echo $apiPers["fields"][0]; ?>"
                                                   name="<?php echo $apiPers["fields"][0]; ?>"
                                        ...
                                        <div class="col-sm-5">
                                            <input type="email"
                                                   class="form-control"
                                                   id="<?php echo $apiPers["fields"][1]; ?>"
                                                   name="<?php echo $apiPers["fields"][1]; ?>"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text"
                                                   class="form-control"
                                                   id="<?php echo $apiPers["fields"][2]; ?>"
                                                   name="<?php echo $apiPers["fields"][2]; ?>"
                                                   readonly="readonly"
                                        ...
                                        <div class="col-sm-5">
                                            <select class="form-control"
                                                    id="<?php echo $apiPers["fields"][3]; ?>"
                                                    name="<?php echo $apiPers["fields"][3]; ?>"
                                                    data-rules='{"required": true}'
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="number"
                                                   class="form-control"
                                                   id="<?php echo $apiPers["fields"][4]; ?>"
                                                   name="<?php echo $apiPers["fields"][4]; ?>"
                                        ...
                                        <div class="col-sm-5">
                                            <input type="number"
                                                   class="form-control"
                                                   id="<?php echo $apiPers["fields"][5]; ?>"
                                                   name="<?php echo $apiPers["fields"][5]; ?>"
            ...
            <div class="box-body" id="addbox">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control"
                                      id="<?php echo $apiPers["fields"][6]; ?>"
                                      name="<?php echo $apiPers["fields"][6]; ?>"
                                      data-rules='{"required": true}'
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input class="form-control"
                                   id="<?php echo $apiPers["fields"][7]; ?>"
                                   name="<?php echo $apiPers["fields"][7]; ?>"
                                   data-rules='{"required": true}'
                        ...
                        <div class="col-sm-5">
                            <input class="form-control"
                                   id="<?php echo $apiPers["fields"][8]; ?>"
                                   name="<?php echo $apiPers["fields"][8]; ?>"
                                   data-rules='{"required": true}'
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input class="form-control"
                                   id="<?php echo $apiPers["fields"][9]; ?>"
                                   name="<?php echo $apiPers["fields"][9]; ?>"
                                   data-rules='{"required": true}'
                        ...
                        <div class="col-sm-5">
                            <input class="form-control"
                                   id="<?php echo $apiPers["fields"][10]; ?>"
                                   name="<?php echo $apiPers["fields"][10]; ?>"
                                   data-rules='{"required": true}'
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input class="form-control"
                                   id="<?php echo $apiPers["fields"][11]; ?>"
                                   name="<?php echo $apiPers["fields"][11]; ?>"
                                   data-rules='{"required": true}'
                        ...
                        <div class="col-sm-5">
                            <input class="form-control"
                                   id="<?php echo $apiPers["fields"][12]; ?>"
                                   name="<?php echo $apiPers["fields"][12]; ?>"
                                   data-rules='{"required": true,"minlength": "3"}'
        ...
        <div class="box collapsed-box">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control"
                               id="<?php echo $apiPers["fields"][13]; ?>"
                               name="<?php echo $apiPers["fields"][13]; ?>"
                ...
                <div class="col-sm-6 form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control"
                                id="<?php echo $apiPers["fields"][14]; ?>"
                                name="<?php echo $apiPers["fields"][14]; ?>"
                                data-rules='{"required": true}'
                ...
                <div class="col-sm-6 form-group">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control"
                               id="<?php echo $apiPers["fields"][15]; ?>"
                               name="<?php echo $apiPers["fields"][15]; ?>"
        ...
        <div class="form-group">
            <div class="col-sm-offset-5 col-sm-10">
                <button type="submit"
                        ...
                        id="<?php echo $apiPers["fields"][16]; ?>"
                        name="<?php echo $apiPers["fields"][16]; ?>"
                        data-rules='{}'
