    ...
    public function signUp() {
        ...
        if ($count > 0) {
            ...
            $res2 = $stm->execute(array(
                ...
                ":id4" => ($picid),
                ":id5" => ($this->postBaseData["details"]["pass"]),
        ...
        sleep(1);
        return $this->welcomeUser($user_pk, $jsondata);
    }

    public function welcomeUser($uid = false, & $jsondata = false) {
        $jsondata = array(
            "email" => '',
            "pass" => '',
            "loggedin" => 0,
        ...
        if ($count > 0) {
            ...
            $jsondata["userdata"] = (array) $_SESSION["USERDATA"]["logindata"];
        }
        return $jsondata;
    }
