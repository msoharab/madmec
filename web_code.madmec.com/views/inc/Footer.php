...
echo $this->config["URL"] .
 ...
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_23"];
?>js/picedit.js" type="text/javascript"></script>
...
echo $this->config["URL"] .
 ...
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_09"];
?>lib/jquery.mousewheel-3.0.6.pack.js"></script>
...
echo $this->config["URL"] .
 ...
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_09"];
?>source/jquery.fancybox.js?v=2.1.5"></script>
...
echo $this->config["URL"] .
 ...
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_09"];
?>source/helpers/jquery.fancybox-thumbs.js?v=1.0.7"></script>
...
echo $this->config["URL"] .
 ...
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_09"];
?>source/helpers/jquery.fancybox-media.js?v=1.0.6"></script>
...
echo $this->config["URL"] .
 ...
 $this->config["ASSSET_PLG"] .
 $this->config["PLG_23"];
?>css/picedit.css" rel="stylesheet" type="text/css" />
