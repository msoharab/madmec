                ...
                <div class="navbar-inverse" role="navigation" id="sidebar">
                    <div class="sidebar-nav navbar-collapse sidebar gray-skin">
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="bt-side">
                                <a href="javascript:void(0);" id="Rewarding" class="atleftmenu"><i class="fa fa-hourglass-end fa-fw "></i>&nbsp;In-line</a>
                            </li>
                            <li class="bt-side">
                                <a href="javascript:void(0);" id="Report" class="atleftmenu"><i class="fa fa-book fa-fw "></i>&nbsp;Report</a>
                            </li>
