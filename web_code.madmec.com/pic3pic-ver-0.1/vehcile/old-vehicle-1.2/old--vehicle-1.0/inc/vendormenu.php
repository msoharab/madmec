                ...
                <div class="navbar-inverse" role="navigation" id="sidebar">
                    <div class="sidebar-nav navbar-collapse sidebar gray-skin">
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="bt-side">
                                <a href="javascript:void(0);" id="Donation" class="atleftmenu"><i class="fa fa-rupee fa-fw fa-x2"></i>&nbsp;Appointments</a>
                            </li>
                            <li class="bt-side">
                                <a href="javascript:void(0);" id="Referral" class="atleftmenu"><i class="fa fa-users fa-fw fa-x2"></i>&nbsp;Upcoming</a>
                            </li>
                            <li class="bt-side">
                                <a href="javascript:void(0);" id="Rewarding" class="atleftmenu"><i class="fa fa-bolt fa-fw fa-x2"></i>&nbsp;In-line</a>
                            </li>
                            <li class="bt-side">
