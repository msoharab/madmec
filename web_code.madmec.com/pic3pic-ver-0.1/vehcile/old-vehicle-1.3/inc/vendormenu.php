...
<html lang="en">
    <head>
        ...
        <script src="<?php echo URL . ASSET_JSF; ?>vendorcontrol.js"></script>
                ...
                <div class="navbar-inverse" role="navigation" id="sidebar">
                    <div class="sidebar-nav navbar-collapse sidebar gray-skin">
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="bt-side">
                                <a href="javascript:void(0);" id="Donation" class="atleftmenu"><i class="fa fa-clock-o fa-fw "></i>&nbsp;Appointments</a>
                            </li>
                            <li class="bt-side">
                                <a href="javascript:void(0);" id="appointeditBut" class="atleftmenu"><i class="fa fa-gear fa-fw "></i>&nbsp;Configure</a>
                            </li>
                            <li class="bt-side">
                                <a href="javascript:void(0);" id="Referral" class="atleftmenu"><i class="fa fa-hourglass-1 fa-fw "></i>&nbsp;Upcoming</a>
                            </li>
                            <li class="bt-side">
                                <a href="javascript:void(0);" id="Rewarding" class="atleftmenu"><i class="fa fa-hourglass-half  fa-fw "></i>&nbsp;In-line</a>
                            </li>
                            <li class="bt-side">
								<a href="javascript:void(0);" id="Completed" class="atleftmenu"><i class="fa fa-hourglass-end fa-fw "></i>&nbsp;Complete</a>
							</li>
                            <li class="bt-side">
								<a href="javascript:void(0);" id="Complaints" class="atleftmenu"><i class="fa fa-ticket fa-fw fa-x2"></i>&nbsp;Complaints</a>
                            </li>
                            <li class="bt-side">
                                <a href="javascript:void(0);" id="Report" class="atleftmenu"><i class="fa fa-book fa-fw "></i>&nbsp;Reports</a>
                            </li>
