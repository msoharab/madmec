function profile()
{
    ...
    function fetchCorporateType()
    {
        $.ajax({
            ...
            data: {
                autoloader: true,
                action: 'vendorprofile/fetchCorporateType',
            },
    ...
    function fetchListOfIndividualDonor()
    {
        $.ajax({
            ...
            data: {
                autoloader: true,
                action: 'vendorprofile/fetchListOfCorporateDonor',
            },
            success: function (data, textStatus, xhr) {
                /*                                        console.log(data);*/
                data = $.trim(data);
    ...
    function viewDetails(donorid, loc, talldata)
    {
        var data = '<div class="col-lg-6">' +
                ...
                '<div class="col-lg-5"><strong>Vehicle Make Type</strong></div>  <div class="col-lg-7">' + talldata[loc]['corporate_type'] + '</div> ' +
...
//								$(add.st_loc).attr('name', ui.item.value);
    ...
    function personalEditDetails(donorid, loc, talldata)
    {
        ...
        var details = '<form id="personaleditform" autocomplete="off">' +
                ...
                '<div class="col-lg-12">' +
                ' <strong><i class="fa fa-star text-danger">&nbsp;</i>Vehicle Make Type  : <i class="fa fa-caret-down fa-fw"></i></strong>' +
                ' </div>' +
                ' <div class="col-lg-12">' +
            ...
            $('#personaleditform').submit(function (evt) {
                ...
                if (editpersonalflag)
                {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: ctrl.url,
                        data: formdata + '&autoloader=true&action=vendorprofile/updateDonorDetails&donorid=' + donorid + '&request=personal',
                        success: function (data, textStatus, xhr) {
                            /*                                        console.log(data);*/
                            data = $.trim(data);
                            switch (data) {
    ...
    function checkEditEmail(donorid)
    {
        $.ajax({
            ...
            data: {
                autoloader: true,
                action: 'vendorprofile/CheckEmail',
                email: $('#eemail').val(),
                donorid: donorid
        ...
        window.setTimeout(function () {
            ...
            $('#communicationeditform').submit(function (evt) {
                ...
                $.ajax({
                    type: 'POST',
                    url: ctrl.url,
                    data: formdata + '&autoloader=true&action=vendorprofile/updateDonorDetails&donorid=' + donorid + '&request=commu',
                    success: function (data, textStatus, xhr) {
                        /*                                        console.log(data);*/
                        data = $.trim(data);
                        switch (data) {
    ...
    function changePassword(formdata)
    {
        ...
        $.ajax({
            type: 'POST',
            url: ctrl.url,
            data: formdata + '&autoloader=true&action=vendorprofile/changeCurrentPassword',
            success: function (data, textStatus, xhr) {
                /*                                        console.log(data);*/
                data = $.trim(data);
                switch (data) {
