...
<html lang="en">
    <head>
        ...
        <script src="<?php echo URL . ASSET_JSF; ?>usercontrol.js"></script>
                    ...
                    <div class="navbar-inverse" role="navigation" id="sidebar">
                        <div class="sidebar-nav navbar-collapse sidebar gray-skin">
                            <ul class="nav" id="side-menu">
                                ...
                                <li class="bt-side">
                                    <a href="javascript:void(0);" id="Vehicle" class="atleftmenu"><i class="fa fa-taxi fa-fw fa-x2"></i>&nbsp;Vehicle</a>
                                </li>
                                <li class="bt-side">
                                    <a href="javascript:void(0);" id="Appointments" class="atleftmenu"><i class="fa fa-rocket fa-fw fa-x2"></i>&nbsp;Appointments</a>
                                </li>
                                <li class="bt-side">
                                    <a href="javascript:void(0);" id="History" class="atleftmenu"><i class="fa fa-bar-chart-o fa-fw fa-x2"></i>&nbsp;History</a>
                                </li>
