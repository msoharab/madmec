                ...
                <div id="wrapper">
                    ...
                    <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0" id="nav-top">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="Vehicle">Vehicle</a>
                        </div>
                        <!-- /.navbar-header -->
                        ...
                        <div class="navbar-inverse" role="navigation" id="sidebar">
                            <div class="sidebar-nav navbar-collapse sidebar gray-skin">
                                <ul class="nav" id="side-menu">
                                    ...
                                    <li class="bt-side">
                                        <a href="javascript:void(0);" id="home" class="atleftmenu"><i class="fa fa-home fa-fw "></i>&nbsp;Home</a>
                                    </li>
                                    <li id="dsf" class="bt-side">
                                        <a href="#"><i class="fa fa-taxi fa-fw fa-x2"></i>&nbsp;Vehicle<span class="fa arrow"></span></a>
                                        <ul class="nav nav-second-level">
                                            <li>
                                                <a href="javascript:void(0);" id="vehicletype" class="menuAL toggle"><i class="fa fa-bolt fa-fw fa-x2"></i> &nbsp;Type</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" id="vehiclemake" class="menuAL toggle"><i class="fa fa-bolt fa-fw fa-x2"></i>&nbsp;Make</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" id="vehiclemodel" class="menuAL toggle"><i class="fa fa-bolt fa-fw fa-x2"></i> &nbsp;Model</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="bt-side">
                                        <a href="javascript:void(0);" id="vendor" class="atleftmenu"><i class="fa fa-user-md fa-fw fa-x2"></i>&nbsp;Vendors</a>
                                    </li>
                                    <li class="bt-side">
                                        <a href="javascript:void(0);" id="users" class="atleftmenu"><i class="fa fa-users fa-fw fa-x2"></i>&nbsp;Users</a>
                                    </li>
                                    <li class="bt-side" style="display: none;">
                                        <a href="javascript:void(0);" id="complaints" class="atleftmenu"><i class="fa fa-ticket fa-fw fa-x2"></i>&nbsp;Complaints</a>
                                    </li>
                                    <li class="bt-side">
                                        <a href="javascript:void(0);" id="Report" class="atleftmenu"><i class="fa fa-bar-chart-o fa-fw fa-x2"></i>&nbsp;Report</a>
                                    </li>
