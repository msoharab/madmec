function vendor()
{
    ...
    this.__construct = function (cctrl) {
        ...
        $(add.form).submit(function (evt) {
            ...
            if (adddonorform && add.emailcheck == 1)
            {
            ...
            success: function (data, textStatus, xhr) {
                ...
                switch (data) {
                    ...
                    default:
                        ...
                        cortype = type;
                        $(add.discorptype).html('<select class="form-control" name="corporatetype" id="corporatetype" required=""><option value="">Please Select Vehicle Make Type</option>' + type.data1 + '</select>');
                        break;
                }
            },
            error: function () {
            ...
            success: function (data, textStatus, xhr) {
                ...
                switch (data) {
                    ...
                    default:
                        ...
                        {
                            var header = '<div class="table-responsive"><table class="table table-striped table-bordered table-hover" id="list_col_table1"><thead><tr><th>#</th><th>Shop Name</th><th>Vehicle Make TYPE</th>\n\
