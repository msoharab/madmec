<?php
//echo print_r($_SESSION["USERDATA"]) .'<hr />'; 
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <?php if (isset($_SESSION["USERDATA"]["loggedin"]) && $_SESSION["USERDATA"]["loggedin"] == 1): ?>
                            <li class="gap-right sm-pad-top">
                                <button type="button" onClick="window.location.href = '<?php echo $this->config["URL"] .  $this->config["CTRL_4"] ; ?>';" class="btn btn-danger sm-height"><i class="fa fa-sign-in"> Logout</i></button></li>
                        <?php else: ?>
                            <li class="gap-right sm-pad-top">
