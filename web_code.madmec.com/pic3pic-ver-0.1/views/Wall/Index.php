                ...
                <fieldset>
                    <div class="modal-body">
                        <div class='conatiner'>
                            ...
                            <div class="input-group">
                                <span class="input-group-addon" id="basic-addon1">                
                                    <input type="radio" name="ex5" value="world" class="gap-right" id="ex5"><label>&nbsp; World </label> 
                                    <span class="gap-right"></span>              
                                    <input type="radio" name="ex5" value="country" checked  class="gap-right" id="ex6"><label>&nbsp; Country</label>
                                </span>
                                <select class="js-example-basic-multiple" id="ex7" name="ex7" multiple="multiple">
