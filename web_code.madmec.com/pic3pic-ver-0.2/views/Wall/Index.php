<div class="container">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-7" id="id="<?php echo $this->idHolders["wall"]["post"]["list"]["parentDiv"]; ?>"">
            <h4 class="">List Posts</h4>
            <div class="thumbnail" id="<?php echo $this->idHolders["wall"]["post"]["list"]["outputDiv"] ?>">           
                <?php
