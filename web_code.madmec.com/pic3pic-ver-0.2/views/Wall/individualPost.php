...
<div class="modal fade" id="<?php echo $create["parentDiv"]; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="" id="<?php echo $create["form"]; ?>" name="<?php echo $create["form"]; ?>" action="<?php echo $this->config["URL"].$this->config["CTRL_18"]; ?>UploadPic" method="post" action="" enctype="multipart/form-data">
                <fieldset>
