					...
					<div class="panel-body" id="pf_usradd_edit" style="display:none;">
								...
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<p class="help-block" id="pf_comsg">Press enter or go button to move to next field.</p>
									</div>
									<div class="col-lg-12">&nbsp;</div>
								</div>
								<!-- State / Province -->
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<p class="help-block" id="pf_prmsg">Press enter or go button to move to next field.</p>
									</div>
									<div class="col-lg-12">&nbsp;</div>
								</div>
								<!-- District / Department -->
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<p class="help-block" id="pf_dimsg">Press enter or go button to move to next field.</p>
									</div>
									<div class="col-lg-12">&nbsp;</div>
								</div>
								<!-- City / Town -->
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<p class="help-block" id="pf_citmsg">Press enter or go button to move to next field.</p>
									</div>
									<div class="col-lg-12">&nbsp;</div>
								</div>
								<!-- Street / Locality -->
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<p class="help-block" id="pf_stlmsg">Press enter or go button to move to next feild.</p>
									</div>
									<div class="col-lg-12">&nbsp;</div>
								</div>
								<!-- Address Line -->
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<p class="help-block" id="pf_admsg">Press enter or go button to move to next field.</p>
									</div>
									<div class="col-lg-12">&nbsp;</div>
								</div>
								<!-- Zipcode -->
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<p class="help-block" id="pf_zimsg">Press enter or go button to move to next field.</p>
									</div>
									<div class="col-lg-12">&nbsp;</div>
								</div>
								<!-- Personal Website -->
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<p class="help-block" id="pf_wemsg">Press enter or go button to move to next field.</p>
									</div>
									<div class="col-lg-12">&nbsp;</div>
								</div>
								<!-- Google Map URL -->
