...
<head>
	...
	<title id="title"><?php echo GYMNAME; ?></title>
...
<div id="menu_header">
	<div id="adm" class="mhead">
		...
		<div class="mhead_list_box">
			...
			<div  onclick="window.open('http://cms.madmec.com/help.php');" class="mhead_list">
	...
	<div id="enquiry" class="mhead">
		...
		<div class="mhead_list_box">
			...
			<div  onclick="window.location.href='<?php echo URL.ADMIN.'enquiry/list_today_enquiries.php'; ?>';" class="mhead_list">
				<img src="<?php echo URL.ASSET_IMG.ICON_THEME2;?>list.png" border="0" width="20" height="20"/>
				<span>List current</span>
			</div>
			<div  onclick="window.location.href='<?php echo URL.ADMIN.'enquiry/list_pending_enquiries.php'; ?>';" class="mhead_list">
				<img src="<?php echo URL.ASSET_IMG.ICON_THEME2;?>list.png" border="0" width="20" height="20"/>
				<span>List pending</span>
			</div>
			<div  onclick="window.location.href='<?php echo URL.ADMIN.'enquiry/list_expired_enquiries.php'; ?>';" class="mhead_list">
				<img src="<?php echo URL.ASSET_IMG.ICON_THEME2;?>list.png" border="0" width="20" height="20"/>
	...
	<div id="stats" class="mhead">
		Stats
		<div class="mhead_list_box">
			<div class="mhead_list" onclick="window.location.href='<?php echo URL.ADMIN.'stats/accounts_stats.php'; ?>';">
				<img src="<?php echo URL.ASSET_IMG.ICON_THEME2;?>accounts.png" border="0" width="20" height="20" alt="Accounts Statistics" />
				<span>Accounts</span>
			</div>
			<div class="mhead_list" onclick="window.location.href='<?php echo URL.ADMIN.'stats/reg_stats.php'; ?>';">
				<img src="<?php echo URL.ASSET_IMG.ICON_THEME2;?>registration.png" border="0" width="20" height="20" alt="Registrations" />
				<span>Registrations</span>
			</div>
			<div class="mhead_list" onclick="window.location.href='<?php echo URL.ADMIN.'stats/customer_stats.php'; ?>';">
				<img src="<?php echo URL.ASSET_IMG.ICON_THEME2;?>stats.png" border="0" width="20" height="20" alt="Customer Statistics" />
				<span>Customers</span>
			</div>
			<div class="mhead_list" onclick="window.location.href='<?php echo URL.ADMIN.'stats/trainer_stats.php'; ?>';">
				<img src="<?php echo URL.ASSET_IMG.ICON_THEME2;?>trainer.png" border="0" width="20" height="20" alt="Trainer Statistics" />
				<span>Trainers</span>
			</div>
		</div>
	</div>
	<div id="reports" class="mhead">
		Reports
		<div class="mhead_list_box">
	...
	<div id="alert" class="mhead">
		Alert <span id="alert_count">( 0 )</span>
		<div class="mhead_list_box">
			<div  onclick="window.location.href='<?php echo URL.ADMIN.'enquiry/list_pending_enquiries.php'; ?>';" class="mhead_list">
				<span>Follow-ups <span id="fol_count">( 0 )</span></span>
			</div>
			<div class="mhead_list" onclick="window.location.href='<?php echo URL.ADMIN.'stats/customer_stats.php'; ?>';">
				<span>Expiry date <span id="exp_count">( 0 )</span></span>
			</div>
			<div  onclick="window.location.href='<?php echo URL.ADMIN.'stats/no_show.php'; ?>';" class="mhead_list">
				<span>No show <span id="track_count">( 0 )</span></span>
			</div>
		</div>
	</div>
</div>
...
$(document).ready(function(){
	...
	$('.mhead').bind('click',function(event){
	...
	window.setTimeout(function(){
		$.ajax({
			url:URL+'Admin/alerts.php',
			type:'post',
			data:{autoloader:'true',action:'LoadAlerts'}
		}).done(function(data){
			var res = data.split('-');
			// Follow ups 
			var fol_count = Number(res[0]);
			$('#fol_count').html('( '+fol_count+' )');
			alert_count += fol_count;
			// Expiring 
			var exp_count = Number(res[1]);
			$('#exp_count').html('( '+exp_count+' )');
			alert_count += exp_count;
			// No show 
			var track_count = Number(res[2]);
			$('#track_count').html('( '+track_count+' )');
			alert_count += track_count;
			$('#alert_count').html('( '+alert_count+' )');
			if(alert_count)
				$('#alert_count').css("color","red");
		});
	},1500);*/
});
</script>