...
class gymreport{
	...
	function GymFeeReport(){
		...
		WHERE STR_TO_DATE(a.`payment_date`, \'%Y-%m-%d\') >= STR_TO_DATE("2014-09-10", \'%Y-%m-%d\') 
				AND STR_TO_DATE(a.`payment_date`, \'%Y-%m-%d\') <= STR_TO_DATE("2014-09-10", \'%Y-%m-%d\')
