...
function clientController(){
       ...
       $(gymbasicinfo.editbut).click(function(evt){
           ...
           $(gymbasicinfo.showDiv).hide();
            ...
            if($(gymbasicinfo.country).val()){
					...
					$('html, body').animate({scrollTop: Number($(gymbasicinfo.comsg).offset().top)-55}, "slow");
				...
				if($(gymbasicinfo.province).val()){
					...
					$('html, body').animate({scrollTop: Number($(gymbasicinfo.prmsg).offset().top)-55}, "slow");
            ...
            if($(gymbasicinfo.district).val()){
					...
					$('html, body').animate({scrollTop: Number($(gymbasicinfo.dimsg).offset().top)-55}, "slow");
            ...
            if($(gymbasicinfo.city_town).val()){
					...
					$('html, body').animate({scrollTop: Number($(gymbasicinfo.citymsg).offset().top)-55}, "slow");
            ...
            if($(gymbasicinfo.st_loc).val()){
					...
					$('html, body').animate({scrollTop: Number($(gymbasicinfo.stlmsg).offset().top)-55}, "slow");
            ...
            if($(gymbasicinfo.addrs).val()){
					...
					$('html, body').animate({scrollTop: Number($(gymbasicinfo.admsg).offset().top)-55}, "slow");
            ...
            if($(gymbasicinfo.zipcode).val()){
					...
					$('html, body').animate({scrollTop: Number($(gymbasicinfo.zimsg).offset().top)-55}, "slow");
            ...
            if($(gymbasicinfo.website).val()){
					...
					$('html, body').animate({scrollTop: Number($(gymbasicinfo.wemsg).offset().top)-55}, "slow");
            ...
            if($(gymbasicinfo.gmaphtml).val()){
					...
					$('html, body').animate({scrollTop: Number($(gymbasicinfo.gmmsg).offset().top)-55}, "slow");
				 ...
				 $.ajax({
						...
						type:'POST',
						data:{autoloader:true,action:'gymeditAddrBasicInfo',addBinfo:attr},
	...
	this.editUserEmailIds = function(email){
			...
			function loadEmailIdForm(){
				...
				$.ajax({
					url:em.url,
					type:'POST',
					data:{autoloader:true,action:'loadClientEmailId',type:'master',det:em},
					success: function(data, textStatus, xhr){
						data = $.parseJSON(data);
						switch(data){
							case 'logout':
									...
									window.setTimeout(function(){
										if(data.oldemail){
											for(i=0;i<data.oldemail.length;i++){
												...
												$('#'+data.oldemail[i].deleteOk).bind("click",{param1:cid},function(event){
			...
			function editEmailId(){
				...
				if(flag){
					...
					$.ajax({
						url:em.url,
						type:'POST',
						data:{autoloader:true,action:'editClientEmailId',type:'master',emailids:emailids},
						success: function(data, textStatus, xhr){
							data = $.parseJSON($.trim(data));
							switch(data){
								case 'logout':
			...
			function deleteEmailId(id){
				...
				$.ajax({
					...
					type:'POST',
					async:false,
					data:{autoloader: true,action:'deleteClientEmailId',type:'master',eid:id},
					success:function(data, textStatus, xhr){
						data = $.trim(data);
						switch(data){
							case 'logout':
			...
			function listEmailIds(){
				...
				$.ajax({
					url:em.url,
					type:'POST',
					data:{autoloader: true,action:'listClientEmailIds',type:'master',para:para},
					success:function(data, textStatus, xhr){
						data = $.trim(data);
						console.log(data);
						switch(data){
	...
	this.editUserCellNumbers = function(cnumber){
			...
			function loadCellNumForm(){
				...
				$.ajax({
					url:cn.url,
					type:'POST',
					data:{autoloader:true,action:'loadClientCellNumForm',type:'master',det:cn},
					success: function(data, textStatus, xhr){
						data = $.parseJSON($.trim(data));
						switch(data){
							case 'logout':
									...
									window.setTimeout(function(){
										if(data.oldcnum){
											for(i=0;i<data.oldcnum.length;i++){
												...
												$('#'+data.oldcnum[i].deleteOk).bind("click",{param1:id},function(event){
													$($(this).prop('name')).hide(400);
			...
			function editCellNum(){
				...
				if(flag){
					...
					$.ajax({
						url:cn.url,
						type:'POST',
						data:{autoloader:true,action:'editClientCellNum',type:'master',CellNums:CellNums},
						success: function(data, textStatus, xhr){
							data = $.parseJSON($.trim(data));
							switch(data){
								case 'logout':
			...
			function deleteCellNum(id){
				...
				$.ajax({
					...
					type:'POST',
					async:false,
					data:{autoloader: true,action:'deleteClientCellNum',type:'master',eid:id},
					success:function(data, textStatus, xhr){
						data = $.trim(data);
						switch(data){
							case 'logout':
			...
			function listCellNums(){
				...
				$.ajax({
					url:cn.url,
					type:'POST',
					data:{autoloader: true,action:'listClientCellNums',type:'master',para:para},
					success:function(data, textStatus, xhr){
						data = $.trim(data);
						switch(data){
							case 'logout':
		...
		console.dir(email);
			...
			function loadEmailIdForm(){
				...
				$.ajax({
					url:em.url,
					type:'POST',
					data:{autoloader:true,action:'loadGYMEmailId1',type:'master',det:em},
					success: function(data, textStatus, xhr){
						data = $.parseJSON(data);
						switch(data){
							case 'logout':
			...
			function editEmailId(){
				...
				if(flag){
					...
					$.ajax({
						url:em.url,
						type:'POST',
						data:{autoloader:true,action:'editGYMEmailId',type:'master',emailids:emailids},
						success: function(data, textStatus, xhr){
							data = $.parseJSON($.trim(data));
							switch(data){
								case 'logout':
			...
			function deleteEmailId(id){
				...
				$.ajax({
					...
					type:'POST',
					async:false,
					data:{autoloader: true,action:'deleteGYMEmailId',type:'master',eid:id},
					success:function(data, textStatus, xhr){
						data = $.trim(data);
						switch(data){
							case 'logout':
			...
			function listEmailIds(){
				...
				$.ajax({
					url:em.url,
					type:'POST',
					data:{autoloader: true,action:'listGYMEmailIds',type:'master',para:para},
					success:function(data, textStatus, xhr){
						data = $.trim(data);
						console.log(data);
						switch(data){
	...
	this.editGYMCellNumbers = function(cnumber){
			...
			function loadCellNumForm(){
				...
				$.ajax({
					url:cn.url,
					type:'POST',
					data:{autoloader:true,action:'loadGYMCellNumForm',type:'master',det:cn},
					success: function(data, textStatus, xhr){
						data = $.parseJSON($.trim(data));
						switch(data){
							case 'logout':
			...
			function editCellNum(){
				...
				if(flag){
					...
					$.ajax({
						url:cn.url,
						type:'POST',
						data:{autoloader:true,action:'editGYMCellNum',type:'master',CellNums:CellNums},
						success: function(data, textStatus, xhr){
							data = $.parseJSON($.trim(data));
							switch(data){
								case 'logout':
			...
			function deleteCellNum(id){
				...
				$.ajax({
					...
					type:'POST',
					async:false,
					data:{autoloader: true,action:'deleteGYMCellNum',type:'master',eid:id},
					success:function(data, textStatus, xhr){
						data = $.trim(data);
						switch(data){
							case 'logout':
			...
			function listCellNums(){
				...
				$.ajax({
					url:cn.url,
					type:'POST',
					data:{autoloader: true,action:'listGYMCellNums',type:'master',para:para},
					success:function(data, textStatus, xhr){
						data = $.trim(data);
						switch(data){
							case 'logout':
	  ...
	  $(doc.gymdocUpdatebtn).bind("click",function(){
	     var attr = {
		  ...
		  $.ajax({
				 	...
				 	type:'POST',
		 			data:{autoloader:'true',action:'gymdataDoc',type:'master',attr:attr},
		 			success:function(data, textStatus, xhr){
		 				htm1='';
		 				data = $.parseJSON($.trim(data));
					switch(data){
	...
	this.gymdeleteflag1 = function(btn){
	  ...
	  $(btn.gymdeleteokbtn).bind("click",function(){
		   $.ajax({
				 	url: window.location.href,
				 	type:'POST',
		 			data:{autoloader:'true',action:'gymDeleTe',type:'master',id:btn.gymid},
		 			success:function(data, textStatus, xhr){
		 				//data = $.trim(data);
		 				alert(data);
					switch(data){
	...
	function userAutoComplete(){
		$.ajax({
			url:ct.url,
			type:'POST',
			data:{autoloader: true,action: 'autoCompleteClient',type:'master'},
			success:function(data, textStatus, xhr){
				data = $.parseJSON(data);
				switch(data){
					case 'logout':
	...
	function bulitUserMultipleEmailIds(){
		...
		var html = '<div id="'+uem.form+uem.num+'">'+
			'<div class="col-lg-8">'+
				...
				'<p class="help-block" id="'+uem.msgDiv+uem.num+'">Press enter or go button to move to next field.</p>'+
			'</div>'+
			'<div class="col-lg-4">'+
	...
	function initializeUserList(dflag){
	  	...
	  	return;
						...
						'<thead>'+
							...
							'<tr>'+
								'<th>#</th>'+
								'<th>User Name</th>'+
								'<th class="text-center">Asc_id</th>'+
     ...
     $(luser.listuserBtn).on("click",function() {
        ...
        $.ajax({
		 url: window.location.href,
		 type:'POST',
		 data:{autoloader:'true',action:'mmuser_list',type:'master'},
		 ...
		 if(data == 'logout')
			window.location.href = URL;
       	   ...
       	   $.ajax({
				 	url: window.location.href,
				 	type:'POST',
		 			data:{autoloader:'true',action:'mmuser_list1',type:'master'},
		 			success:function(data, textStatus, xhr){
					htm='';
					data = $.trim(data);
					switch(data){
						...
						default:
						    ...
						    for(i=0;i<total_record;i++){
					        $(listusers[i]["showgym"]).bind('click',{uid:listusers[i].uid},function(evt){
	...
	function displayGymdata(selectid) {
      ...
      $.ajax({
				 	url: window.location.href,
				 	type:'POST',
		 			data:{autoloader:'true',action:'mmgymlist_data1',type:'master',id:gymid},
		 			success:function(data, textStatus, xhr){
		 				htm1='';
					switch(data){
						case 'logout':
						...
						var total = listgymusers.length;
						 for(i=0;i<total;i++){
						  ...
						  for(i=0;i<total;i++){
							 var allData = {addressform:listgymusers[i]["addressform"],gymcountryval:listgymusers[i]["gymcountry"],gymprovivnceval:listgymusers[i]["gymprovince"],gymdistrictval:listgymusers[i]["gymdistrict"],gymcityval:listgymusers[i]["gymcity_town"],gymstreetval:listgymusers[i]["gymst_loc"],gymaddrsval:listgymusers[i]["gymaddrs"],gymzipcodeval:listgymusers[i]["gymzipcode"],gymwebsiteval:listgymusers[i]["gymwebsite"],gymgmapval:listgymusers[i]["gymgmaphtml"],gymEditListcloseBtn:listgymusers[i]["gymeditlistclbtn"],gymaddCloseBut:listgymusers[i]["gymaddCloseBut"],gymaddSaveBut:listgymusers[i]["gymaddSaveBut"],gymaddUpadteDiv:listgymusers[i]["gymaddUpdateDiv"],gymaddEditBut:listgymusers[i]["gymaddEditBut"],gymaddDiv:listgymusers[i]["gymaddDiv"],gid:listgymusers[i].gid,editdiv:listgymusers[i]["gymEditDiv"],edigymaddtbut:listgymusers[i]["gymaddEditBut"],editgymemailbut:listgymusers[i]["gymemailEditBut"],editgymcellbut:listgymusers[i]["gymcellEditBut"]}
								...
								$(listgymusers[i]["gymdeleteokbtn"]).bind('click',{gid:listgymusers[i]["gymid"]},function(evt){
									//$($(this).prop('name')).hide(400);
								...
								$(listgymusers[i]["gymflagokbtn"]).bind('click',{gid:listgymusers[i]["gymid"]},function(evt){
									$($(this).prop('name')).hide(400);
									var hid = flagGYM(evt.data.gid);
									$("#listgymsbut").click();
								});
								$(listgymusers[i]["gymunflagokbtn"]).bind('click',{gid:listgymusers[i]["gymid"]},function(evt){
									$($(this).prop('name')).hide(400);
	...
	function loadGymEmailIdForm(emaildata){
				...
				$.ajax({
					url:window.location.href,
					type:'POST',
					data:{autoloader:true,action:'loadGymEmailId',type:'master',det:em},
					success: function(data, textStatus, xhr){
						data = $.parseJSON(data);
						switch(data){
							case 'logout':
   ...
   function gymaddressEditData(gymData,selectid) {
    ...
    $(gymData.gymaddEditBut).hide();
	 ...
	 $.ajax({
            url : window.location.href,
            type : 'POST',
            data :{autoloader:'true',action:'gymaddressedit',type:'master',attr:gymupdata},
            success:function(data, textStatus, xhr){
             data = $.parseJSON($.trim(data));
              //console.log(data);
					switch(data){
   ...
   //delete client
	function deleteClient(uid){
			...
			$.ajax({
				...
				type:'POST',
				async:false,
				data:{autoloader: true,action:'deleteClient',type:'master',uid:entid},
				success:function(data, textStatus, xhr){
	...
	function editClient(id){
		...
		$.ajax({
				...
				type:'POST',
				async:false,
				data:{autoloader: true,action:'editClient',type:'master',usrid:usrid},
				success:function(data, textStatus, xhr){
					//data = $.trim(data);
					switch(data){
						case 'logout':
	...
	function flagUser(id) {
		...
		$.ajax({
			url:window.location.href,
			type:'POST',
			data:{autoloader:true,action:'flagClient',type:'master',fuser:uid},
			success: function (data, textStatus, xhr) {
				data = $.trim(data);
				//console.log(data);
				 if(!data){
	...
	function unflagUser(id) {
		...
		$.ajax({
			url:window.location.href,
			type:'POST',
			data:{autoloader:true,action:'unflagClient',type:'master',ufuser:uid},
			success: function (data, textStatus, xhr) {
				console.log(data);
				data = $.trim(data);
				if(data){
	...
	function bulitUserMultipleCellNumbers(){
		...
		var html = '<div class="row show-grid" id="'+ucn.form+ucn.num+'">'+
					'<div class="col-xs-6 col-md-4">'+
						'<input class="form-control" value="'+dccode+'" pattern="[0-9]{2,15}$" name="cellnumbers['+ucn.num+'][codep]" required type="text" id="'+ucn.codep+ucn.num+'" maxlength="15" />'+
					'</div>'+
					'<div class="col-xs-6 col-md-4">'+
						'<input class="form-control" placeholder="Cell Number" pattern="[0-9]{10,20}$" required name="cellnumbers['+ucn.num+'][nump]" type="text" id="'+ucn.nump+ucn.num+'" maxlength="20" />'+
					'</div>'+
					...
					'</div>'+
				'</div>'+
				'<div class="col-lg-12"><p class="help-block" id="'+ucn.msgDiv+ucn.num+'">Press enter or go button to move to next field.</p></div>';
	...
	function validateGYMFields(){
			...
			if($(add.mgym).val().length>0){
				...
				$('html, body').animate({scrollTop: Number($(add.mgmsg).offset().top)-95}, "slow");
				$(add.mgym).focus();
				return;
			}
			 // gym name name*nmsg
			...
			if($(add.fee).val().match(number_reg)){
				...
				$('html, body').animate({scrollTop: Number($(add.fmsg).offset().top)-95}, "slow");
				$(add.fee).focus();
				return;
			}
			...
			if($(add.address.country).val()){
				...
				$('html, body').animate({scrollTop: Number($(add.address.comsg).offset().top)-95}, "slow");
			...
			if($(add.address.province).val()){
				...
				$('html, body').animate({scrollTop: Number($(add.address.prmsg).offset().top)-95}, "slow");
				$(add.address.addbody).show();
				$(add.address.province).focus();
				return;
			}
			...
			if($(add.address.district).val()){
				...
				$('html, body').animate({scrollTop: Number($(add.address.dimsg).offset().top)-95}, "slow");
				$(add.address.addbody).show();
				$(add.address.district).focus();
				return;
			}
			 // gym zipcode-zimsg
			if($(add.address.zipcode).val() || $(add.address.zipcode).val().match(ZIP_reg)){
				flag = true;
				...
				$('html, body').animate({scrollTop: Number($(add.address.zimsg).offset().top)-95}, "slow");
				$(add.address.addbody).show();
	...
	function bulitMultipleCellNumbers(){
			...
			var html = '<div class="row show-grid" id="'+cn.form+cn.num+'">'+
						'<div class="col-xs-6 col-md-4">'+
							'<input class="form-control" required="required" value="'+dccode+'" name="ccode" type="text" id="'+cn.codep+cn.num+'" maxlength="15" />'+
						'</div>'+
						'<div class="col-xs-6 col-md-4">'+
							'<input class="form-control" required="required" placeholder="Cell Number" name="cnumber" type="text" id="'+cn.nump+cn.num+'" maxlength="20" />'+
						'</div>'+
	...
	function deleteGym(uid){
			...
			$.ajax({
				...
				type:'POST',
				async:false,
				data:{autoloader:'true',action:'gymDeleTe',type:'master',id:entid},
				success:function(data, textStatus, xhr){
  ...
  // gym flag btn
   function flagGYM(id) {
		...
		$.ajax({
			url:window.location.href,
			type:'POST',
			data:{autoloader:true,action:'flagGYM',type:'master',fuser:uid},
			success: function (data, textStatus, xhr) {
				data = $.trim(data);
				//console.log(data);
				 if(!data){
	...
	function unflagGYM(id) {
		...
		$.ajax({
			url:window.location.href,
			type:'POST',
			data:{autoloader:true,action:'unflagGYM',type:'master',ufuser:uid},
			success: function (data, textStatus, xhr) {
				console.log(data);
				data = $.trim(data);
				if(data){
...
//                });
		...
		$.ajax({
			...
			type:'POST',
			async:false,
			data:{autoloader:true,action:'pageLoad',type:'master'},
			success: function(data, textStatus, xhr){
				data = $.trim(data);
				switch(data){
					case 'logout':
		...
		$(leftbuttons.one).click(function(evt){
			...
			addres = new Address();
			addres.__construct({url : add_gym.address.url,outputDiv:clnt.outputDiv});
			//addres.getIPData(clnt);
		...
		$(leftbuttons.last).click(function(evt){
			...
			$.ajax({
				type:'POST',
				url:window.location.href,
				data:{autoloader:true,action:'logout',type:'master'},
				success:function(data, textStatus, xhr){
					data = $.trim(data);
					console.log(xhr.status);
					switch(data){
		 ...
		 //$("#addusrForm").validate({
			...
			//messages: {
				...
				//doc_number: "Please enter document number",
			//},
