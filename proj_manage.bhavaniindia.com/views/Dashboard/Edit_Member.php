<?php
$Mem = isset($this->idHolders["ricepark"]["dashboard"]["EditMembers"]) ? (array) $this->idHolders["ricepark"]["dashboard"]["EditMembers"] : false;
?>
<!-- start content-outer -->
                                ...
                                <tr valign="top">
                                    <td>                                            <!--  start step-holder -->
                                        <div id="step-holder">
                                            ...
                                            <div class="step-dark-left"><a href="">Edit Members Details</a></div>
                                            <div class="step-dark-right">&nbsp;</div>
                                            <div class="step-no-off"></div>
                                        </div>
                                        <!--  end step-holder -->
                                        <input type="hidden"
                                               name="<?php echo $Mem["fields"][11]; ?>"
                                               id="<?php echo $Mem["fields"][11]; ?>"
                                               data-rules='{}'
                                               data-messages='{}'
                                               value="<?php echo base64_encode($this->getuserDet["data"]["id"]); ?>" />
                                        <input type="hidden"
                                               name="<?php echo $Mem["fields"][12]; ?>"
                                               id="<?php echo $Mem["fields"][12]; ?>"
                                               data-rules='{}'
                                               data-messages='{}'
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text"
                                                           ...
                                                           value="<?php echo trim($this->getuserDet["data"]["designation"]); ?>"
                                                           data-rules='{"required": true}'
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="email"
                                                           ...
                                                           value="<?php echo trim($this->getuserDet["data"]["email"]); ?>"
                                                           data-rules='{"required": true}'
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                           ...
                                                           value="<?php echo trim($this->getuserDet["data"]["cell_1"]); ?>"
                                                           data-rules='{"required": true}'
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                           ...
                                                           value="<?php echo trim($this->getuserDet["data"]["cell_2"]); ?>"
                                                           data-rules='{}'
                                                           data-messages='{}'
                                                           placeholder="Mobile No " /></td>
                                                <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="noheight">
                                                    <input type="url"
                                                           ...
                                                           value="<?php echo trim($this->getuserDet["data"]["facebook_link"]); ?>"
                                                           data-rules='{"required": true}'
                                            ...
                                            <tr>
                                                ...
                                                <td class="noheight">
                                                    <input type="url"
                                                           ...
                                                           value="<?php echo trim($this->getuserDet["data"]["twitter_link"]); ?>"
                                                           data-rules='{"required": true}'
                                            ...
                                            <tr>
                                                ...
                                                <td class="noheight">
                                                    <input type="url"
                                                           ...
                                                           value="<?php echo trim($this->getuserDet["data"]["googleP_link"]); ?>"
                                                           data-rules='{"required": true}'
                                            ...
                                            <tr>
                                                ...
                                                <td><textarea rows="" cols="" class="form-textarea"
                                                              ...
                                                              placeholder="Address"><?php echo trim($this->getuserDet["data"]["address"]); ?></textarea></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <th>Upload Image:</th>
