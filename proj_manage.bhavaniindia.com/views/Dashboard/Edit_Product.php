<?php
$Prod = isset($this->idHolders["ricepark"]["dashboard"]["EditProduct"]) ? (array) $this->idHolders["ricepark"]["dashboard"]["EditProduct"] : false;
?>
<!-- start content-outer -->
                                ...
                                <tr valign="top">
                                    <td>                                            <!--  start step-holder -->
                                        <div id="step-holder">
                                            ...
                                            <div class="step-dark-left"><a href="">Edit Product Details</a></div>
                                            <div class="step-dark-right">&nbsp;</div>
                                            <div class="step-no-off"></div>
                                        </div>
                                        <!--  end step-holder -->
                                        <input type="hidden"
                                               name="<?php echo $Prod["fields"][8]; ?>"
                                               id="<?php echo $Prod["fields"][8]; ?>"
                                               data-rules='{}'
                                               data-messages='{}'
                                               value="<?php echo base64_encode($this->getuserDet["data"]["id"]); ?>" />
                                        <input type="hidden"
                                               name="<?php echo $Prod["fields"][9]; ?>"
                                               id="<?php echo $Prod["fields"][9]; ?>"
                                               data-rules='{}'
                                               data-messages='{}'
                                               value="<?php echo trim($this->getuserDet["data"]["photo_id"]); ?>" />
                                        <!-- start id-form -->
                                        <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="styledselect_form_1"
                                                        ...
                                                        <?php
                                                        if(trim($this->getuserDet["data"]["name"]) == "Sona Masoori"){
                                                            echo '<option selected="selected">Sona Masoori</option>
                                                        <option>Non Basmati</option>
                                                        <option>Lachkari</option>';
                                                        }
                                                        else if(trim($this->getuserDet["data"]["name"]) == "Non Basmati"){
                                                            echo '<option>Sona Masoori</option>
                                                        <option selected="selected">Non Basmati</option>
                                                        <option>Lachkari</option>';
                                                        }
                                                        else{
                                                            echo '<option>Sona Masoori</option>
                                                        <option >Non Basmati</option>
                                                        <option selected="selected">Lachkari</option>';
                                                        }
                                                        ?>
                                                    </select>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text"
                                                           ...
                                                           value="<?php echo trim($this->getuserDet["data"]["brand"]); ?>"
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text"
                                                           ...
                                                           value="<?php echo trim($this->getuserDet["data"]["category"]); ?>"
                                                           data-rules='{"required": true}'
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                           ...
                                                           value="<?php echo trim($this->getuserDet["data"]["price"]); ?>"
                                                           data-rules='{"required": true}'
                                            ...
                                            <tr>
                                                ...
                                                <td class="noheight">
                                                    <input type="number"
                                                           ...
                                                           value="<?php echo trim($this->getuserDet["data"]["quantity"]); ?>"
                                                           data-rules='{"required": true}'
                                            ...
                                            <tr>
                                                ...
                                                <td><textarea rows="" cols="" class="form-textarea"
                                                              ...
                                                              placeholder="Description"><?php echo trim($this->getuserDet["data"]["description"]); ?></textarea>
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
...
<script>$(document).ready(function () {
        ...
        if (this_js_script) {
            ...
            if (flag === 'true') {
                ...
                obj.__setDefualtImage('<?php echo $this->getuserDet["data"]["photo"];?>');
                obj.__constructor(para);
                obj.__EditProduct(para);
            }
            else {
