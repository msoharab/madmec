...
<body id="login-bg">
    ...
    <div id="login-holder">
        ...
        <div id="loginbox">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td><input type="password"
                                       ...
                                       data-messages='{"required": "Enter Password","minlength": "Length Should be minimum 4 Characters"}'
            ...
            <!--  end login-inner -->
            <div class="clear"></div>
            <a href="<?php echo $this->config["URL"] . $this->config["CTRL_8"]; ?>" class="forgot-pwd">Forgot Password?</a>
        </div>
        <!--  end loginbox -->
