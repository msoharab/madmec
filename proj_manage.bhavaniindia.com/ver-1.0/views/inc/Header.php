...
<div class="nav-outer-repeat">
    ...
    <div class="nav-outer">
        ...
        <div id="nav-right">
            ...
            <div class="showhide-account"><img src="<?php echo $this->config["URL"] . $this->config["VIEWS"] . $this->config["ASSSET_IMG"]; ?>shared/nav/nav_myaccount.gif" width="93" height="14" alt="" /></div>
            <div class="nav-divider">&nbsp;</div>
            ...
            <div class="account-content">
                <div class="account-drop-inner">
                    <a href="<?php echo $this->config["URL"] . $this->config["CTRL_5"]; ?>" id="acc-settings">Change Password</a>
                    <div class="clear">&nbsp;</div>
                    <div class="acc-line">&nbsp;</div>
                    <a href="<?php echo $this->config["URL"] . $this->config["CTRL_4"]; ?>" id="acc-details">Sign Out</a>
                    <div class="clear">&nbsp;</div>
                </div>
            </div>
            <!--  end account-content -->
