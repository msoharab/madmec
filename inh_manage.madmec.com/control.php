...
/* Marketing Manager Location Param */

$marketloc=array(
    "markid" => isset($_POST["mmadd"]["mgrrid"]) ? $_POST["mmadd"]["mgrrid"] : false,
    "country" => isset($_POST["mmadd"]["country"]) ? $_POST["mmadd"]["country"] : false,
    "countryCode" => isset($_POST["mmadd"]["countryCode"]) ? $_POST["mmadd"]["countryCode"] : false,
    "province" => isset($_POST["mmadd"]["province"]) ? $_POST["mmadd"]["province"] : false,
    "provinceCode" => isset($_POST["mmadd"]["provinceCode"]) ? $_POST["mmadd"]["provinceCode"] : false,
    "district" => isset($_POST["mmadd"]["district"]) ? $_POST["mmadd"]["district"] : false,
    "city_town" => isset($_POST["mmadd"]["city_town"]) ? $_POST["mmadd"]["city_town"] : false,
    "st_loc" => isset($_POST["mmadd"]["st_loc"]) ? $_POST["mmadd"]["st_loc"] : false,
    "addrsline" => isset($_POST["mmadd"]["addrsline"]) ? $_POST["mmadd"]["addrsline"] : false,
    "zipcode" => isset($_POST["mmadd"]["zipcode"]) ? $_POST["mmadd"]["zipcode"] : false,
    "website" => isset($_POST["mmadd"]["website"]) ? $_POST["mmadd"]["website"] : false,
    "gmaphtml" => isset($_POST["mmadd"]["gmaphtml"]) ? $_POST["mmadd"]["gmaphtml"] : false,
    "timezone" => isset($_POST["mmadd"]["timezone"]) ? $_POST["mmadd"]["timezone"] : false,
    "lat" => isset($_POST["mmadd"]["lat"]) ? $_POST["mmadd"]["lat"] : false,
    "lon" => isset($_POST["mmadd"]["lon"]) ? $_POST["mmadd"]["lon"] : false,
);
/* Add quotation */
$qut_add = array(
...
$parameters = array(
    ...
    "marketloc"  => isset($marketloc) ? (array) $marketloc : false,
);
            ...
            if (!ValidateAdmin()) {
                ...
                switch ($parameters["action"]) {
                    ...
                    case "logout": {
                        ...
                        break;
                    /* Marketing Manager Module Implementation  */

                    case "fetchmm" : {
                              $obj=new marketingmanager();
                               echo (json_encode($obj->fetchMM()));
                    }
                    break;
                    case "marketinglocadd" : {
                        $obj = new marketingmanager($parameters["marketloc"]);
                            echo(json_encode($obj->addMarketinLocation()));
                    }
                    break;
                case "fetchlocwisemm" : {
                              $obj=new marketingmanager();
                               echo (json_encode($obj->fetchLocWiseMM(isset($_POST["mid"]) ? $_POST["mid"] : false)));
                               break;
                    }
                    /*
                      START project.php
