$(document).ready(function () {
    ...
    $(leftbuttons.etn).click(function () {
        ...
        var personaldet =
                {
                    menuBut: '#personal_filebut',
                    displaydata: '#personal_file_data',
                };
        var userprof = {
    ...
    $(leftbuttons.twenty).on('click',function(){
        $(OUTPUT).html($.trim(MODULES.marketingmanager));
        var user_addAddress = {
            country: '#country',
            countryCode: null,
            countryId: null,
        ...
        var add={
           ...
           name : '#mmname',
           menuBut : '#addlocmenuBut',
           but   : '#addMMBut',
           mgrid : 0,
           cmgrid : 0,
        };
        var list={
           menuBut : '#listlocmenuBut',
           listmm : '#listmarketingmanagers',
           lmmname : '#lmmname',
           lmgrid : 0,
           lcmgrid : 0,
        };
        var marketing = {
            ...
            address  : user_addAddress,
            outputDiv: '#output',
            msgDiv  : '#marketing_msg',
            url: window.location.href,
        };
        var obj = new marketingmanager();
        obj.__construct(marketing);
    });
