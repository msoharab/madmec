function userController() {
    ...
    this.editUserEmailIds = function (email) {
        ...
        function addMultipleEmailIds() {
            ...
            var html = '<div class="col-lg-12"><div class="form-group input-group" id="' + oldemail.formid + '">' +
    ...
    this.editUserPans = function (pann) {
        ...
        function addMultiplePans() {
            ...
            var html = '<div class="col-lg-12"><div class="form-group input-group" id="' + oldpan.formid + '">' +
    ...
    this.editUserStc = function (stcc) {
        ...
        function addMultipleStc() {
            ...
            var html = '<div class="col-lg-12"><div class="form-group input-group" id="' + oldstc.formid + '">' +
    ...
    this.editUserTins = function (tinn) {
        ...
        function addMultipleTin() {
            ...
            var html = '<div class="col-lg-12"><div class="form-group input-group" id="' + oldtin.formid + '">' +
    ...
    this.editUserCellNumbers = function (cnumber) {
        ...
        function addMultipleCellNums() {
            ...
            var html = '<div class="col-lg-12"><div class="form-group input-group" id="' + oldcnum.formid + '">' +
    ...
    this.editUserProducts = function (prdname) {
        ...
        function addMultiplePrdNames() {
            ...
            var html = '<div class="col-lg-12"><div class="form-group input-group" id="' + oldprdname.formid + '">' +
...
//                        console.log(data);
    ...
    function userAdd() {
        ...
        if (($(usr.add.address.pcode).val() != ""))
        {
            if (($(usr.add.address.pcode).val().match(PCODE)) && (Number($(usr.add.address.pcode).val()) != 0))
            {
                flag = true;
                $(usr.add.address.pcode_msg).html('');
            }
            else
            {
                $(usr.add.address.pcode).focus();
                $(usr.add.address.pcode_msg).html(INVALIDNOT);
                flag = false;
                return;
            }
        }

        if (($(usr.add.address.tphone).val() != ""))
        {
            if (($(usr.add.address.tphone).val().match(PCODE)) && (Number($(usr.add.address.tphone).val()) != 0))
            {
                flag = true;
                $(usr.add.address.tpmsg).html('');
            }
            else
            {
                $(usr.add.address.tpmsg).html(INVALIDNOT);
                $(usr.add.address.tphone).focus();
                flag = false;
                return;
            }
        }
