function requirementController() {
    ...
    function addMultiplePart() {
        ...
        var html = '<div id="' + par.form + par.num + '">' +
                ...
                '<button type="button"  class="btn btn-danger btn-md" id="' + par.minus + par.num + '"><i class="fa fa-minus fa-fw fa-x2"></i></button>&nbsp;' +
                '<button  type="button" class="btn btn-success btn-md" id="' + par.plus + par.num + '"><i class="fa fa-plus fa-fw fa-x2"></i></button>' +
                '</div>' +
                ...
                '<button type="button"  class="text-primary btn btn-success  btn-md" name="' + par.num + '" id="' + del.plus + par.num + '"><i class="fa fa-plus fa-fw fa-x2"></i></button>&nbsp; ' +
                '</div>' +
    ...
    function addMultipleDelivi(ind) {
        ...
        var html = '<div id="' + del.form + pind + '_' + index + '">' +
                ...
                '<button type="button"  class="btn btn-danger btn-md" style="display:none;" id="' + del.minus + pind + '_' + index + '"><i class="fa fa-minus fa-fw fa-x2"></i></button>&nbsp;' +
                '<button type="button"  class="btn btn-success btn-md" style="display:none;" name="' + pind + '" id="' + del.plus + pind + '_' + index + '"><i class="fa fa-plus fa-fw fa-x2"></i></button>' +
                '</div>' +
                '<div class="panel-body">' +
                '<div class="row">' +
                '<div class="col-lg-6">' +
    ...
    function addMultipleBlock() {
        ...
        html = '<!-- Block -->' +
                ...
                '<button type="button"  class="btn btn-danger  btn-md" id="' + block.minus + block.num + '"><i class="fa fa-minus fa-fw fa-x2"></i></button>&nbsp;' +
                '<button type="button"  class="btn btn-success  btn-md" id="' + block.plus + block.num + '"><i class="fa fa-plus fa-fw fa-x2"></i></button>' +
                '</div>' +
                '<div class="panel-body">' +
                '<div class="row">' +
                '<div class="col-lg-12">' +
                ...
                '<button type="button"  class="text-primary btn btn-success  btn-md" name="' + block.num + '" id="' + floor.plus + block.num + '"><i class="fa fa-plus fa-fw fa-x2"></i></button>&nbsp; ' +
                '</div>' +
    ...
    function addMultipleFloor(ind) {
        ...
        var html = '<!-- Floor -->' +
                ...
                '<button type="button" class="btn btn-danger btn-md" name="' + pind + '" id="' + floor.minus + pind + '_' + index + '"><i class="fa fa-minus fa-fw fa-x2"></i></button>&nbsp;' +
                '<button type="button" class="btn btn-success btn-md" name="' + pind + '" id="' + floor.plus + pind + '_' + index + '"><i class="fa fa-plus fa-fw fa-x2"></i></button>' +
                '</div>' +
                '<div class="panel-body">' +
                '<div class="row">' +
                '<div class="col-lg-12">' +
                ...
                '<button type="button"  class="text-primary btn btn-success  btn-md" name="' + index + '" id="' + pdesc.plus + pind + '_' + index + '"><i class="fa fa-plus fa-fw fa-x2"></i></button>&nbsp; ' +
                '</div>' +
    ...
    function addMultipleBFDesc(ind) {
        ...
        var html = '<div id="' + pdesc.form + ind.ppind + '_' + ind.pind + '_' + index + '">' +
                ...
                '<button type="button" sclass="btn btn-danger  btn-md" id="' + pdesc.minus + ind.ppind + '_' + ind.pind + '_' + index + '"><i class="fa fa-minus fa-fw fa-x2"></i></button>&nbsp;' +
                '<button type="button"  class="btn btn-success  btn-md" id="' + pdesc.plus + ind.ppind + '_' + ind.pind + '_' + index + '"><i class="fa fa-plus fa-fw fa-x2"></i></button>' +
                '</div>' +
                '<div class="panel-body">' +
                '<div class="row">' +
                '<div class="col-lg-4">' +
