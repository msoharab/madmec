<?php
$optype = isset($this->idHolders["recharge"]["operator"]["AddOperatorType"]) ? (array) $this->idHolders["recharge"]["operator"]["AddOperatorType"] : false;
?>
        ...
        <div class="box-body">
            <div class="col-sm-12">
                <div class="form-group">
                    <label for="inputservicee" class="col-sm-1 control-label">Operator</label>
                    <div class="col-sm-11">
