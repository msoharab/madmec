...
//            }
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                ...
                frmdata.append("btype", $('#' + fields[0]).val());
                frmdata.append("cname", $('#' + fields[1]).val());
                frmdata.append("doc", $('#' + fields[2]).val());
                frmdata.append("website", $('#' + fields[4]).val());
                frmdata.append("addline", $('#' + fields[5]).val());
                frmdata.append("country", $('#' + fields[6]).val());
                frmdata.append("state", $('#' + fields[7]).val());
                frmdata.append("distct", $('#' + fields[8]).val());
                frmdata.append("city", $('#' + fields[9]).val());
                frmdata.append("stloc", $('#' + fields[10]).val());
                frmdata.append("zipc", $('#' + fields[11]).val());
    ...
    function bindBankEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("cmpname", $('#' + fields[0]).val());
                frmdata.append("acname", $('#' + fields[1]).val());
                frmdata.append("acno", $('#' + fields[2]).val());
                frmdata.append("acifsc", $('#' + fields[3]).val());
                frmdata.append("bnkame", $('#' + fields[4]).val());
                frmdata.append("bnkcode", $('#' + fields[5]).val());
                frmdata.append("bbrname", $('#' + fields[6]).val());
                frmdata.append("bbrcode", $('#' + fields[7]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindSetCurrencyEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("company_currency_id", $('#' + fields[3]).val());
                frmdata.append("company", $('#' + fields[0]).val());
                frmdata.append("currency", $('#' + fields[1]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindAddServiceEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("services_id", $('#' + fields[6]).val());
                frmdata.append("company", $('#' + fields[0]).val());
                frmdata.append("name", $('#' + fields[1]).val());
                frmdata.append("code", $('#' + fields[2]).val());
                frmdata.append("flatcommission", $('#' + fields[3]).val());
                frmdata.append("variablecommission", $('#' + fields[4]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindAddOperatorEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("operator_id", $('#' + fields[7]).val());
                frmdata.append("serv", $('#' + fields[0]).val());
                frmdata.append("name", $('#' + fields[1]).val());
                frmdata.append("ocde", $('#' + fields[2]).val());
                frmdata.append("alas", $('#' + fields[3]).val());
                frmdata.append("flat", $('#' + fields[4]).val());
                frmdata.append("variable", $('#' + fields[5]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindAddOperatorTypeEvents(attr) {
        ...
        $(form).submit(function (e) {
            //e.preventDefault();
            var frmdata = new FormData();
            frmdata.append("operator_type_id", $('#' + fields[6]).val());
            frmdata.append("operator", $('#' + fields[0]).val());
            frmdata.append("optype", $('#' + fields[1]).val());
            frmdata.append("optypecode", $('#' + fields[2]).val());
            frmdata.append("flat", $('#' + fields[3]).val());
            frmdata.append("variable", $('#' + fields[4]).val());
            AddDB({jsonattr: register, attr: frmdata});
        });
    }
    ;
...
//            e.preventDefault();
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("portal_countries_id", $('#' + fields[11]).val());
                frmdata.append("continent", $('#' + fields[0]).val());
                frmdata.append("countname", $('#' + fields[1]).val());
                frmdata.append("countcap", $('#' + fields[2]).val());
                frmdata.append("countiso", $('#' + fields[3]).val());
                frmdata.append("countis3", $('#' + fields[4]).val());
                frmdata.append("countisn", $('#' + fields[5]).val());
                frmdata.append("counttld", $('#' + fields[6]).val());
                frmdata.append("countfib", $('#' + fields[7]).val());
                frmdata.append("countphn", $('#' + fields[8]).val());
                frmdata.append("countcurnm", $('#' + fields[9]).val());
                frmdata.append("countcurcd", $('#' + fields[10]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindCurrenciesAddEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("curr_id", $('#' + fields[4]).val());
                frmdata.append("country", $('#' + fields[0]).val());
                frmdata.append("currname", $('#' + fields[1]).val());
                frmdata.append("currcode", $('#' + fields[2]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindBusinessTypesAddEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("business_type_id", $('#' + fields[3]).val());
                frmdata.append("country", $('#' + fields[0]).val());
                frmdata.append("btype", $('#' + fields[1]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindMOPAddEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("mop_id", $('#' + fields[2]).val());
                frmdata.append("mop", $('#' + fields[0]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindMOSAddEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("mos_id", $('#' + fields[2]).val());
                frmdata.append("mos", $('#' + fields[0]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindProtocolAddEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("pname", $('#' + fields[0]).val());
                frmdata.append("pbname", $('#' + fields[1]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindRestParamAddEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("rest_param_id", $('#' + fields[4]).val());
                frmdata.append("Param", $('#' + fields[0]).val());
                frmdata.append("meang", $('#' + fields[1]).val());
                frmdata.append("desc", $('#' + fields[2]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindProofAddEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("proof_id", $('#' + fields[3]).val());
                frmdata.append("country", $('#' + fields[0]).val());
                frmdata.append("proof", $('#' + fields[1]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindUserTypeAddEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("userType_id", $('#' + fields[3]).val());
                frmdata.append("userType", $('#' + fields[0]).val());
                frmdata.append("minBalance", $('#' + fields[1]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindEditBusinessEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("company_id", $('#' + fields[12]).val());
                frmdata.append("btype", $('#' + fields[0]).val());
                frmdata.append("cname", $('#' + fields[1]).val());
                frmdata.append("doc", $('#' + fields[2]).val());
                frmdata.append("website", $('#' + fields[3]).val());
                frmdata.append("addline", $('#' + fields[4]).val());
                frmdata.append("country", $('#' + fields[5]).val());
                frmdata.append("state", $('#' + fields[6]).val());
                frmdata.append("distct", $('#' + fields[7]).val());
                frmdata.append("city", $('#' + fields[8]).val());
                frmdata.append("stloc", $('#' + fields[9]).val());
                frmdata.append("zipc", $('#' + fields[10]).val());
                AddDB({jsonattr: register, attr: frmdata});
            }
        });
    }
    ...
    function bindEditBankEvents(attr) {
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("company_bank_accounts_id", $('#' + fields[9]).val());
                frmdata.append("cmpname", $('#' + fields[0]).val());
                frmdata.append("acname", $('#' + fields[1]).val());
                frmdata.append("acno", $('#' + fields[2]).val());
                frmdata.append("acifsc", $('#' + fields[3]).val());
...
//        });
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("country", $('#' + fields[1]).val());
                frmdata.append("btype", $('#' + fields[2]).val());
                EditBusinessDB(frmdata);
            }
        });
    }
    ;
...
//        });
        ...
        $(form).submit(function (e) {
            ...
            if (flag) {
                var frmdata = new FormData();
                frmdata.append("country", $('#' + fields[1]).val());
                frmdata.append("currname", $('#' + fields[2]).val());
                frmdata.append("currcode", $('#' + fields[3]).val());
                EditBusinessDB(frmdata);
            }
        });
    }
