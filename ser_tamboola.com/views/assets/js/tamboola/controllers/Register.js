function Register() {
    ...
    function bindAddUserEvents() {
        ...
        $(form).submit(function (e) {
            if (checkusr) {
                ...
                frmdata.append("email", $('#' + fields[1]).val());
                frmdata.append("mobile", $('#' + fields[2]).val());
                frmdata.append("gender", $('#' + fields[3]).val());
                frmdata.append("pass1", $('#' + fields[4]).val());
                frmdata.append("pass2", $('#' + fields[5]).val());
                frmdata.append("utype", $('#' + fields[6]).val());
                AddUserDB(frmdata);
            }
            else {
                alert('Please correct the credentials..');
    ...
    function fetchGender() {
        var mem = members.Register.gender;
        var fields = members.Register.fields;
        var obj = {};
        $.ajax({
            url: mem.url,
