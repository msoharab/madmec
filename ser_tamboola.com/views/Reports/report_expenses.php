<?php
$ExpenRepo = isset($this->idHolders["tamboola"]["reports"]["ExpensesRepo"]) ? (array) $this->idHolders["tamboola"]["reports"]["ExpensesRepo"] : false;
?>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <h3 class="box-header">Expenses Report</h3>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="box-body" id="ff">
                                    <form class="form-horizontal"
                                          action=""
                                          id="<?php echo $ExpenRepo["form"]; ?>"
                                          name="<?php echo $ExpenRepo["form"]; ?>"
                                          method="post">
                                        <!-- form id-->
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input class="form-control"
                                                           id="<?php echo $ExpenRepo["fields"][0]; ?>"
                                                           name="<?php echo $ExpenRepo["fields"][0]; ?>"
                                                ...
                                                <div class="col-sm-4">
                                                    <input class="form-control"
                                                           id="<?php echo $ExpenRepo["fields"][1]; ?>"
                                                           name="<?php echo $ExpenRepo["fields"][1]; ?>"
                                                           data-rules='{"required": true}'
                                                           data-messages='{"required": "Enter Date"}'
                                                           placeholder="Enter Date" type="text" style="cursor:pointer">
                                                    <span class="text-success"><!--
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="form-group">
                                                        <button type="submit"
                                                                ...
                                                                id="<?php echo $ExpenRepo["fields"][2]; ?>"
                                                                name="<?php echo $ExpenRepo["fields"][2]; ?>"
                                                                data-rules='{}'
