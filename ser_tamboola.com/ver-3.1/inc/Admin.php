					...
					<div class="sidebar-nav navbar-collapse sidebar">
						<ul class="nav" id="side-menu">
							...
							<li id="gymname" class="bt-side">
								<a href="javascript:void(0);" class="menuAL toggle"><img src="<?php echo LOGO_1; ?>" class="img-circle" width="50" />
								<label name="0"><?php echo $gym_name; ?></label></a>
							</li>
							<li id="home" class="bt-side">
								<a href="javascript:void(0);" class="menuAL toggle"><i class="fa fa-home fa-x2"></i> Home</a>
							</li>
							<?php echo $users; ?>
							<!-- /.nav-enquiry -->
							...
							<?php } else {?>
							<label id="printrs" name="0"><img src="<?php echo LOGO_1; ?>" class="img-circle" width="50" /> <?php echo $gym_name; ?></label></a>
