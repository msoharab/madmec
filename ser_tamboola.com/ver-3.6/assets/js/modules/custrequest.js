            ...
            success: function (data) {
                ...
                switch (data) {
                    ...
                    default:
                        ...
                        {
                            $(usreq.displaydetailsreq).html('<div class="table-responsive"><table class="table table-striped table-hover" id="list_col_table">' +
                                    '<thead><tr><th>#</th><th>Name</th><th>Email</th><th>Gender</th><th>option</th></tr></thead>' +
                                    '<tbody>' + details.data + '</tbody></table></div>');
