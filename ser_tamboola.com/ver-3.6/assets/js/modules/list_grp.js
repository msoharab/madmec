                ...
                success: function (data) {
                    if (data == 'logout')
                        ...
                        var gcheader = '<table class="table table-striped table-bordered table-hover" id="list_groupmem_table">' +
                                '<thead>' +
                                '<tr>' +
                                '<th colspan="8" class="text-center">List Of Members' +
                                '<!--&nbsp;&nbsp;&nbsp;<button class="text-center btn btn-danger btn-md" id="grplist_Back_But"><i class="fa fa-reply fa-fw "></i>Back</button>-->' + '</th>' +
                                '</tr>' +
                                '<tr>' +
                                '<th>No</th>' +
                                '<th>Customer Name</th>' +
            ...
            success: function (data) {
                if (data == 'logout')
                    ...
                    var gheader = '<table class="table table-striped table-bordered table-hover" id="list_group_table">' +
                            '<thead>' +
                            '<tr>' +
                            '<th colspan="8" class="text-center">Lists Of Groups</th>' +
                            '</tr>' +
                            '<tr>' +
                            '<th>#</th>' +
                            '<th>Name</th>' +
                            ...
                            '<th class="text-center">Members - Delete - Flag/Unflag</th>' +
                            '</tr>' +
                            '</thead>';
                    var gfooter = '</table>';
