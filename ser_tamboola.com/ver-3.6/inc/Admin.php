<?php
$gym_name = 'Your Owner Has Not Yet Assigned A Club / Gym To You.';
$gym_id = (int) NULL;
...
<html lang="en">
    ...
    <body>
        <div id="page-loader" style="position:relative;width:58%;height:58%;padding:20% 20% 20% 20%;">
            <h1>Tamboola ver 3.0 ..<img class="img-circle" src="<?php echo URL . ASSET_IMG; ?>loader2.gif" border="0" width="22" height="22" /></h1>
        </div>
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="javascript:void(0);">Tamboola</a>
                        ...
                        <ul class="nav navbar-top-links navbar-right">
                            ...
                            <?php if ($gym_name != 'Your Owner Has Not Yet Assigned A Club / Gym To You.') : ?>
                                <li class="dropdown">
                            ...
                            <li class="dropdown" style="display:none;">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                    <img class="img-circle" src="<?php echo URL . ASSET_IMG . ICON_THEME; ?>stats.png" border="0" width="24" height="24"/>  <span id="alert_count">(0)</span> <i class="fa fa-caret-down"></i>
                                </a>
                                <ul class="dropdown-menu">
                                    <li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-user">
                                    ...
                                    <li class="divider"></li>
                                    <li>
                                        <a href="javascript:void(0);" onclick="window.location.href = '<?php echo URL . 'logout.php'; ?>';"><i class="fa fa-sign-out fa-fw"></i>Logout</a>                                </li>
                                </ul>
                                <!-- /.dropdown-user -->
                            </li>
                        </ul>
					...
					<ul class="nav" id="side-menu">
                        <?php if ($gym_name != 'Your Owner Has Not Yet Assigned A Club / Gym To You') : ?>
                            ...
                            <li id="customers" class="bt-side">
                                <a href="#">
                                    <img class="img-circle" src="<?php echo URL . ASSET_IMG . ICON_THEME; ?>customer.png" border="0" width="24" height="24"/>
                            ...
                            <li id="stats" class="bt-side" style="display:none;">
                                <a href="#">
                            ...
                            <li id="reports" class="bt-side">
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class="menuAL toggle" id="RBalanceSheet" style="display:none;">
