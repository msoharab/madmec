				...
				if($res){
					...
					if($res1){
						...
						if($res2){
							...
							fwrite($fh, $voucher);
							fclose($fh);
							echo '<strong><h3 style="color:#FF0000;">Voucher Added Successfully</h3></strong> <br />
								<div class="btn-group">
									<button type="button" class="btn btn-danger btn-lg" onclick="javascript:dis_voc(\'cheque\')">New Cheque voucher</button>
								  </div>
								  <div class="btn-group">
									<button type="button" class="btn btn-success btn-lg" onclick="javascript:dis_voc(\'cash\')">New Cash voucher</button>
								  </div>';
			...
			echo '
				<tbody>     
                                    <tr>
										...
										<td>
											'.date('d-m-Y',strtotime($vouchers[$i]['date']) ).'
										</td>
										<td>
										<a onClick=\'window.open("'.$vouchers[$i]['location'].'", "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=10, left=100, width=400, height=400",titlebar="no")\' class="btn btn-danger">Print</a>
									
											  <a  href="'.URL.'php/edit/edit_vouchers.php?id='.base64_encode($vouchers[$i]['id']).'" target="_blank" class="btn btn-warning">Edit</a>
											 <a data-toggle="collapse" data-parent="#accordion" href="#collapse_'.$vouchers[$i]['id'].'" target="_blank" class="btn btn-warning">View</a>
											<button class="btn btn-danger" onclick="javasript:critical_action('.$vouchers[$i]['id'].',\'delete\');">
	...
	function DisVoc($val){
		...
		echo '<div class="col-md-12">
                    <div class="panel panel-'.$color.'">
                        <div class="panel-heading" id="voc_type_che">
                            '.$voc_type.'
                        </div>
							<div class="panel-body">
						<form role="form">
									...
									<div class="form-group" '.$cheque_no.'>
										...
										<label>Cheque No</label>
											<div class="form-group input-group">
												...
												<input id="cheque_no" type="text" maxlength="6" class="form-control"  placeholder="999999">
											</div>
												...
												<div class="form-group">
													...
													<label class="manditory">Sum of Rupees</label>
														<div class="form-group input-group">
															...
															<input id="amount" onkeyDown="javascript:number_allow_sumofruppes();" type="text" class="form-control"  placeholder="9999.99">
														</div>
