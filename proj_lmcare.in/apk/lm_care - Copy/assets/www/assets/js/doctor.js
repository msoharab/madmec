        ...
        function ebuildMultipleSlots(apptid)
        {
         if (doctor.appointment.enum == -1) $(doctor.appointment.emultiple_slots+apptid).html('');
           ...
           var htm='<div id="'+doctor.appointment.eform +doctor.appointment.enum+'">'+
                   '<div class="form-group">'+
                    '<div class="col-md-12"><label> Slot '+doctor.appointment.ej+'</label>'+
                    ...
                    '<div class="col-md-3">'+
                    '<label>no of Patient</label>'+
                    '<input type="text" name="efrequencyappoint'+doctor.appointment.enum+'" id="efrequencyappoint'+doctor.appointment.enum+'" placeholder="no of Patient" class="form-control"/>'+
                    '</div></div>'+
                   '</div>';
