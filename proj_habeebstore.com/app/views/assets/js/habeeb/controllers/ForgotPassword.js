...
$(document).ready(function () {
	var this_js_script = $("script[src$='ForgotPassword.js']");
	if (this_js_script) {
		var flag = this_js_script.attr('data-autoloader');
		if (flag === 'true') {
			LogMessages('I am In ForgotPassword');
			var para = getJSONIds({
				autoloader: true,
				action: 'getIdHolders',
				url: EGPCSURL + 'ForgotPassword/getIdHolders',
				type: 'POST',
				dataType: 'JSON'
			}).shop.index;
			...
			LogMessages('I am Out ForgotPassword');
		}
	}
});
