...
<link href="<?php echo URL . ASSET_CSS . PLUGINS. DATATABLES; ?>jquery.dataTables.min.css" 					rel="stylesheet"  type="text/css" />
<link href="<?php echo URL . ASSET_CSS . PLUGINS. DATATABLES; ?>buttons.dataTables.min.css" 					rel="stylesheet"  type="text/css" />
...
<link href="<?php echo URL . ASSET_CSS . PLUGINS; ?>picedit.min.css" 					rel="stylesheet"  type="text/css" />
...
<script src="<?php echo URL . ASSET_JSF; ?>bootstrap.min.js" 				language="javascript" charset="UTF-8" ></script>
<script src="<?php echo URL . ASSET_JSF . PLUGINS . METISMENU; ?>metisMenu.min.js" 		language="javascript" charset="UTF-8" ></script>
<script src="<?php echo URL . ASSET_JSF . PLUGINS . DATATABLES; ?>jquery.dataTables.min-1.10.10.js" 	language="javascript" charset="UTF-8" ></script>
<script src="<?php echo URL . ASSET_JSF . PLUGINS . DATATABLES; ?>dataTables.buttons.min.js" 	language="javascript" charset="UTF-8" ></script>
<script src="<?php echo URL . ASSET_JSF . PLUGINS . DATATABLES; ?>buttons.colVis.min.js" 	language="javascript" charset="UTF-8" ></script>
<script src="<?php echo URL . ASSET_JSF . PLUGINS . DATATABLES; ?>buttons.print.min.js" 	language="javascript" charset="UTF-8" ></script>
<script src="<?php echo URL . ASSET_JSF . PLUGINS . DATATABLES; ?>dataTables.bootstrap.js" 	language="javascript" charset="UTF-8" ></script>
<script src="<?php echo URL . ASSET_JSF; ?>sb-admin-2.js" 				language="javascript" charset="UTF-8" ></script>
...
<script src="<?php echo URL . ASSET_JSF . PLUGINS; ?>picedit.js" 				language="javascript" charset="UTF-8" ></script>
<!--
<script src="<?php echo URL . ASSET_JSF . PLUGINS; ?>jquery.countdown.js" 			language="javascript" charset="UTF-8" ></script>
<script src="<?php echo URL; ?>avatar/cropper.min.js" 	language="javascript" charset="UTF-8" ></script>
<script src="<?php echo URL; ?>avatar/main.js" 		language="javascript" charset="UTF-8" ></script>
<link rel="stylesheet" type="text/css" href="<?php echo URL; ?>picEdit-master/src/css/font.css" />
<link rel="stylesheet" type="text/css" href="<?php echo URL; ?>picEdit-master/src/css/picedit.css" />
<script type="text/javascript" src="<?php echo URL; ?>picEdit-master/src/js/picedit.js"></script>
-->
