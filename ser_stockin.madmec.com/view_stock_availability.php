...
$SQL = "SELECT * FROM  stock_avail WHERE store_id=$ttstoreid";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$SQL = "SELECT * FROM  stock_avail WHERE store_id=$ttstoreid AND name LIKE '%".$_POST['searchtxt']."%'";
...
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$query = "SELECT COUNT(*) as num FROM  stock_avail WHERE store_id=$ttstoreid AND  name LIKE '%".$_POST['searchtxt']."%' ";
...
if($page) 
	...
	/* Get data. */
	$sql = "SELECT * FROM stock_avail WHERE store_id=$ttstoreid LIMIT $start, $limit ";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
	$sql= "SELECT * FROM  stock_avail WHERE store_id=$ttstoreid AND  name LIKE '%".$_POST['searchtxt']."%'  LIMIT $start, $limit";
...
<tr>
   ...
   <td> <?php $quantity = $db->queryUniqueValue("SELECT quantity FROM stock_avail WHERE store_id=$ttstoreid AND  name='".$row['name']."'"); echo $quantity; ?></td>
   <td>&nbsp;</td><td>&nbsp;</td>
</tr>
<?php $i++; } ?>
 <tr>
