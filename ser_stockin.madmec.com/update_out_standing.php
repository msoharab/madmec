...
<div id="content">
	...
	<div class="page-full-width cf">
		...
		if($db->query("UPDATE stock_entries  SET balance=$balance,payment=$payment,due='$due' where stock_id='$id' AND store_id=$ttstoreid"))
		{
		$db->query("INSERT INTO transactions(type,supplier,payment,balance,rid,due,subtotal,store_id) values('entry','$supplier',$newpayment,$balance,'$id','$due',$subtotal,$ttstoreid)");
