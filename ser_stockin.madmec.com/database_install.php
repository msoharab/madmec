...
<head>
<meta charset="utf-8">
<title>MADMEC - Login to Control Panel</title>
...
<div id="header">
	...
	<div class="page-full-width cf">
		...
		<a href="#" id="company-branding" class="fr"><img src="upload/logo.png" alt="MadMec" /></a>
...
if (!$link) {
	...
	<form action="setup_page.php" method="POST" id="login-form" class="cmxform" autocomplete="off">
			...
			<p>
                            ...
                            // Check connection
                                 $sql="CREATE DATABASE MY_MADMEC_1234";
                                  if (mysqli_query($con,$sql)){
                                       $sql="DROP DATABASE MY_MADMEC_1234";
