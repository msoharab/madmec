    ...
    <td align="center">
      <table width="595" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="left"><table width="300" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="150">&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(subtotal) FROM stock_entries where store_id=$rstoreid AND count1=1 AND type='entry' AND date BETWEEN '$fromdate' AND '$todate' ");?></td>
                </tr>
                <tr>
                  <td><strong>Paid Amount</strong></td>
                  <td>&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(payment) FROM stock_entries where store_id=$rstoreid AND count1=1 AND type='entry' AND date BETWEEN '$fromdate' AND '$todate' ");?></td>
                </tr>
                <tr>
                  <td width="150"><strong>Pending Payment </strong></td>
                  <td width="150">&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(balance) FROM stock_entries where store_id=$rstoreid AND count1=1 AND type='entry' AND date BETWEEN '$fromdate' AND '$todate' ");?></td>
                </tr>
              </table></td>
              <td align="right">&nbsp;</td>
            </tr>
        ...
        <tr>
		  ...
		  <?php 
		  $result = $db->query("SELECT * FROM stock_entries where store_id=$rstoreid AND type='entry' AND date BETWEEN '$fromdate' AND '$todate' ");
