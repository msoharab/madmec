           ...
           if(r){ 
  			...
  			success: function(data) {
    			...
    			window.location = "view_category.php";
                        jAlert('Category Is Deleted', 'MADMEC');
  			}
	});
            }
            return r;
...
$SQL = "SELECT * FROM  category_details AND store_id=$ttstoreid";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$SQL = "SELECT * FROM  category_details WHERE store_id=$ttstoreid AND  category_name LIKE '%".$_POST['searchtxt']."%' ";
...
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$query = "SELECT COUNT(*) as num FROM  category_details WHERE store_id=$ttstoreid AND  category_name LIKE '%".$_POST['searchtxt']."%' ";
...
if($page) 
	...
	/* Get data. */
	$sql = "SELECT * FROM category_details WHERE store_id=$ttstoreid LIMIT $start, $limit ";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
	$sql= "SELECT * FROM  category_details WHERE (store_id=$ttstoreid) AND (category_name LIKE '%".$_POST['searchtxt']."%') LIMIT $start, $limit";
