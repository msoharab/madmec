           ...
           if(r){ 
  			...
  			success: function(data) {
    			window.location ='view_sales.php';
                        ...
                        jAlert('Sales Is Deleted', 'MADMEC');
  			}
	});
            }
            return r;
...
$SQL = "SELECT DISTINCT(transactionid) FROM  stock_sales WHERE `store_id`='".$_SESSION['storeid']."'";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$SQL = "SELECT DISTINCT(transactionid) FROM  stock_sales WHERE stock_name LIKE '%".$_POST['searchtxt']."%' AND `store_id`='".$_SESSION['storeid']."'";
	...
	*/
	$query = "SELECT COUNT(transactionid) as num FROM $tbl_name WHERE `store_id`='".$_SESSION['storeid']."'";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$query = "SELECT COUNT(transactionid) as num FROM stock_sales WHERE stock_name LIKE '%".$_POST['searchtxt']."%' AND `store_id`='".$_SESSION['storeid']."'";
...
if($page) 
	...
	/* Get data. */
	$sql =  "SELECT * FROM stock_sales WHERE `store_id`='".$_SESSION['storeid']."' ORDER BY date desc LIMIT $start, $limit  ";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
	$sql= "SELECT * FROM stock_sales WHERE stock_name LIKE '%".$_POST['searchtxt']."%' AND `store_id`='".$_SESSION['storeid']."' ORDER BY date desc LIMIT $start, $limit";
