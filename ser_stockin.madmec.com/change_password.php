		...
		<div class="side-content fr">
			...
			<?php
                                if(isset($_POST['old_pass']) and isset($_POST['new_pass']) and isset($_POST['confirm_pass'])){
                                 ...
                                 $count = $db->countOf("stock_user", "username='$username' and password='$old_pass' AND store_id=$ttstoreid");
						if($count==0)
						{
                                                            ...
                                                            if(trim($_POST['new_pass'])==trim($_POST['confirm_pass'])){
                                                                ...
                                                                $db->query("update stock_user  SET password='$con' where username='$username' AND store_id=$ttstoreid");
