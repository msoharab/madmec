...
$SQL = "SELECT DISTINCT(stock_id) FROM  stock_entries WHERE (type LIKE 'entry%' AND balance>0) AND store_id=$ttstoreid";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$SQL = "SELECT DISTINCT(stock_id) FROM  stock_entries WHERE (store_id=$ttstoreid) AND (stock_name LIKE '%".$_POST['searchtxt']."%') and (balance>0  AND type LIKE 'entry%')";
	...
	*/
	$query = "SELECT COUNT(stock_id) as num FROM $tbl_name where (type LIKE 'entry%' and balance>0) AND store_id=$ttstoreid";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$query = "SELECT COUNT(stock_id) as num FROM stock_entries WHERE (store_id=$ttstoreid) AND (stock_name LIKE '%".$_POST['searchtxt']."%' and balance>0 AND type LIKE 'entry%')";
...
if($page) 
	...
	/* Get data. */
	$sql =  "SELECT * FROM stock_entries where (store_id=$ttstoreid) AND (type LIKE 'entry%' and balance>0) ORDER BY date desc LIMIT $start, $limit  ";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
	$sql= "SELECT * FROM stock_entries WHERE (store_id=$ttstoreid) AND (stock_name LIKE '%".$_POST['searchtxt']."%' AND type LIKE 'entry%' AND balance>0)  ORDER BY date desc LIMIT $start, $limit";
