	function materialController() {
	                ...
	                success: function(data, textStatus, xhr) {
	                    ...
	                    switch (data) {
	                        ...
	                        default:
	                            ...
	                            $(Morder.add_item.form).get(0).reset();
	                            $('html, body').animate({
	    ...
	    function fetchmaterialorderedsupplieddetails() {
	        $(Morder.order_supplied.displayorded).html("");
	                ...
	                switch (data) {
	                    ...
	                    default:
	                        ...
	                        if (itemlist != null) {
	                            ...
	                            var header = '<div class="col-md-12"><div class="panel panel-danger"><div class="panel-heading">  Item Supplied Details </div><div class="panel-body"><div class="panel-group" id="view_itemsupplied">';
	                ...
	                switch (data) {
	                    ...
	                    default:
	                        ...
	                        if (itemlist != null) {
	                            ...
	                            var header = '<div class="col-md-12"><div class="panel panel-warning"><div class="panel-heading">  Material Order Details </div><div class="panel-body"><div class="panel-group" id="view_materialordered">';
	                            var footer = '</div></div></div></div>';
	                        ...
	                        if (vendorlist != null) {
	                            ...
	                            window.setTimeout(function() {
	                                $('#' + Morder.order.ven_id).change(function() {
	                                    var id = $(this).select().val();
	                                    if (id != 'NULL') Morder.order.vid = id;
	                                });
	                            }, 300);
	                        }
	                        break;
