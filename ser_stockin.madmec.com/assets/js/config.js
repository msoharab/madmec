	...
	var INC_MOD 		= INC+"modules/";
        var SA_INC_MOD          = INC+"superadminmodules/";
	var LOAD_MODULE		= URL+INC+"moudules.php";
	...
	var MODULES = {};
	var OUTPUT = '#output';
	var MODULE_CPO = URL+INC_MOD+'clientpo.html';
	var MODULE_DUE = URL+INC_MOD+'due.html';
	var MODULE_FOLLOW_UP = URL+INC_MOD+'follow_up.html';
	var MODULE_INCOMMING = URL+INC_MOD+'incomming.html';
	var MODULE_INVOICE = URL+INC_MOD+'invoice.html';
	var MODULE_MO = URL+INC_MOD+'mo.html';
	var MODULE_OUTGOING = URL+INC_MOD+'outgoing.html';
	var MODULE_PCC = URL+INC_MOD+'pcc.html';
	var MODULE_PCASH = URL+INC_MOD+'pettycash.html';
	var MODULE_PP = URL+INC_MOD+'pp.html';
	var MODULE_QUOT = URL+INC_MOD+'quotation.html';
	var MODULE_REP = URL+INC_MOD+'report.html';
	var MODULE_REQ = URL+INC_MOD+'requirement.html';
	var MODULE_SIGNOUT = URL+INC_MOD+'signout.html';
	var MODULE_STOCK = URL+INC_MOD+'stock.html';
	var MODULE_USER = URL+INC_MOD+'user.html';
        var MODULE_USERPROFILE = URL+INC_MOD+'userprofile.html';
        var MODULE_SETTING = URL+INC_MOD+'setting.html';
	...
	var MOD_NOTIFY = URL+SA_INC_MOD+'notify.html';
        ...
        var Bill_Logo=URL+ASSET_IMG+'billlogo.jpg';
...
//                               console.log(data);
				...
				$(OUTPUT).html('<center><h2> Welcome To MIS <h2><center>');
			}
		});
