...
<div id="content">
	...
	<div class="page-full-width cf">
		...
		if($db->query("UPDATE stock_details  SET stock_name ='$name',supplier_id='$supplier',company_price='$cost',selling_price='$sell',category='$Category',date='$date'  where id=$id AND  store_id=$ttstoreid"))
		{ 
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
		...
		echo "<br><font color=red size=+1 >Problem in Updation !</font>" ;
			...
			$line = $db->queryUniqueObject("SELECT * FROM stock_details WHERE id=$id AND store_id=$ttstoreid");
			?>
	<form name="form1" method="post" id="form1" action="">
