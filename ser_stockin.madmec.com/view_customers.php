           ...
           if(r){ 
  			...
  			success: function(data) {
    			window.location = "view_customers.php";
                        ...
                        jAlert('Custmer Is Deleted', 'MADMEC');
  			}
	});
            }
            return r;
...
$SQL = "SELECT * FROM  customer_details WHERE  `store_id`='".$_SESSION['storeid']."'";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$SQL = "SELECT * FROM  customer_details WHERE (`store_id`='".$_SESSION['storeid']."') AND  (customer_name  LIKE '%".$_POST['searchtxt']."%' OR customer_address LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%')";
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE `store_id`='".$_SESSION['storeid']."'";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$query = "SELECT COUNT(*) as num FROM  customer_details WHERE (`store_id`='".$_SESSION['storeid']."') AND (customer_name  LIKE '%".$_POST['searchtxt']."%' OR customer_address LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%');";
...
if($page) 
	...
	/* Get data. */
	$sql = "SELECT * FROM customer_details WHERE `store_id`='".$_SESSION['storeid']."' LIMIT $start, $limit ";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
	$sql= "SELECT * FROM  customer_details WHERE (`store_id`='".$_SESSION['storeid']."') AND(customer_name  LIKE '%".$_POST['searchtxt']."%' OR customer_address LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%')  LIMIT $start, $limit";
