...
$SQL = "SELECT DISTINCT(transactionid) FROM  stock_sales where balance>0 AND store_id=$ttstoreid";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$SQL = "SELECT DISTINCT(transactionid) FROM  stock_sales WHERE (store_id=$ttstoreid) AND (stock_name LIKE '%".$_POST['searchtxt']."%' OR supplier_name LIKE '%".$_POST['searchtxt']."%' OR transactionid  LIKE '%".$_POST['searchtxt']."%' OR date LIKE '%".$_POST['searchtxt']."%') AND (balance>0)";
...
$query = "SELECT COUNT(*) as num FROM $tbl_name where balance>0 AND store_id=$ttstoreid";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$query = "SELECT COUNT(*) as num FROM stock_sales WHERE (store_id=$ttstoreid) AND (stock_name LIKE '%".$_POST['searchtxt']."%' OR supplier_name LIKE '%".$_POST['searchtxt']."%' OR transactionid  LIKE '%".$_POST['searchtxt']."%' OR date LIKE '%".$_POST['searchtxt']."%') AND (balance > 0)";
...
$page = $_GET['page'];
	...
	/* Get data. */
$sql = "SELECT DISTINCT(transactionid) FROM  stock_sales where balance>0 AND store_id=$ttstoreid ORDER BY date desc LIMIT $start, $limit ";

if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$sql = "SELECT DISTINCT(transactionid) FROM  stock_sales WHERE (store_id=$ttstoreid) AND (stock_name LIKE '%".$_POST['searchtxt']."%' OR supplier_name LIKE '%".$_POST['searchtxt']."%' OR transactionid  LIKE '%".$_POST['searchtxt']."%' OR date LIKE '%".$_POST['searchtxt']."%') ORDER BY date desc LIMIT $start, $limit";
...
while($row = mysql_fetch_array($result)) 
{
		...
		$line = $db->queryUniqueObject("SELECT * FROM stock_sales WHERE transactionid='$entryid' AND store_id=$ttstoreid");
		$mysqldate=$line->due;
