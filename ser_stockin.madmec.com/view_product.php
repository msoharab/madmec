           ...
           if(r){ 
  			...
  			success: function(data) {
    			window.location ='view_product.php';
                        ...
                        jAlert('Product Is Deleted', 'MADMEC');
  			}
	});
            }
            return r;
...
$SQL = "SELECT * FROM  stock_details WHERE store_id=$ttstoreid";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$SQL = "SELECT * FROM  stock_details WHERE (store_id=$ttstoreid) AND stock_name LIKE '%".$_POST['searchtxt']."%' OR supplier_address LIKE '%".$_POST['searchtxt']."%' OR supplier_id LIKE '%".$_POST['searchtxt']."%' OR date LIKE '%".$_POST['searchtxt']."%'";
...
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
$query = "SELECT COUNT(*) as num FROM  stock_details WHERE (store_id=$ttstoreid) AND  (stock_name LIKE '%".$_POST['searchtxt']."%' OR stock_id LIKE '%".$_POST['searchtxt']."%' OR supplier_id LIKE '%".$_POST['searchtxt']."%' OR date LIKE '%".$_POST['searchtxt']."%')";
...
if($page) 
	...
	/* Get data. */
	$sql = "SELECT * FROM stock_details WHERE store_id=$ttstoreid LIMIT $start, $limit ";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
	$sql= "SELECT * FROM  stock_details WHERE (store_id=$ttstoreid) AND  (stock_name LIKE '%".$_POST['searchtxt']."%' OR stock_id LIKE '%".$_POST['searchtxt']."%' OR supplier_id LIKE '%".$_POST['searchtxt']."%' OR date LIKE '%".$_POST['searchtxt']."%')  LIMIT $start, $limit";
...
<tr>
   ...
   <td> <?php $quantity = $db->queryUniqueValue("SELECT quantity FROM stock_avail WHERE name='".$row['stock_name']."' AND store_id=$ttstoreid"); echo $quantity; ?></td>
