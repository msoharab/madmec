...
<table width="595"  cellspacing="0" cellpadding="0" id="bordertable"  border="1">
      <tr>
        <td align="center"><strong>Sales Receipt <br />
		  ...
		  $sid=$_GET['sid'];
		$line = $db->queryUniqueObject("SELECT * FROM stock_sales WHERE transactionid='$sid' AND store_id=$ttstoreid");
	...
	echo $phpdate;
      ...
      <tr>
        <td height="90" align="left" valign="top"><br />
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			$line2 = $db->queryUniqueObject("SELECT * FROM customer_details WHERE customer_name='$cname' AND store_id=$ttstoreid ");
	  ...
	  <?php
	  $i=1;
	 $db->query("SELECT * FROM stock_sales where transactionid='$sid' AND store_id=$ttstoreid");
