...
<div id="content">
	...
	<div class="page-full-width cf">
		...
		if($db->query("UPDATE supplier_details  SET supplier_name ='$name',supplier_address='$address',supplier_contact1='$contact1',supplier_contact2='$contact2' where id=$id AND store_id=$ttstoreid"))
                        {	
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
		...
		echo "<br><font color=red size=+1 >Problem in Updation !</font>" ;
			...
			$line = $db->queryUniqueObject("SELECT * FROM supplier_details WHERE id=$id AND store_id=$ttstoreid");
			?>
				<form name="form1" method="post" id="form1" action="">
