<?php
	...
	function UpdateReceipt(){
		...
		$towards= $_POST['des'];
		$org_date = date('d-m-Y',  strtotime($_POST['date']));
			...
			if(($db_select = selectDB(DBNAME_ZERO,$link)) == 1){
				...
				if($res){
					...
					`for` = '".mysql_real_escape_string($towards)."',
                                        ...
                                        `date` = '".mysql_real_escape_string($alt_date)."'
					WHERE `id` = '".$income_id."'
					; ";
							...
							<div class="panel-body">
								<form role="form">
									...
									<div class="col-md-4">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                    ...
                                                                                    <input type="hidden" id="alt-date" class="form-control" value="'.date( 'Y-m-d',strtotime($receipts['date']) ).'" >
									...
									<div class="form-group"  style="display:none;">
										...
										<input id="mobile" type="text" maxlength="10" onkeyDown="javascript:number_allow();" value="'.$receipts['phone'].'" class="form-control" placeholder="9900000000">
