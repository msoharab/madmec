...
<?php
	...
	define("SOFT_NAME","MADMEC-MANAGEMENT");
	...
	define("MODULE_SETTING",DOC_ROOT.INC_MOD."setting.html");
        define("MODULE_MARKETING",DOC_ROOT.INC_MOD."marketingmanager.html");
		...
		if(!isset($_SESSION["USER_LOGIN_DATA"])){
			...
			$query = 'SELECT a.*,
						...
						AND a.`password`="'.mysql_real_escape_string($_SESSION["USER_LOGIN_DATA"]["USER_PASS"]).'"
                                                AND a.`user_type_id`="'.mysql_real_escape_string($_SESSION["USER_LOGIN_DATA"]["user_type_id"]).'"
...
//                                        "slavedb" => isset($_SESSION["USER_LOGIN_DATA"]['slavedb']) ? $_SESSION["USER_LOGIN_DATA"]['slavedb'] : false,
	...
	function generateInvoice($receipt){
		...
		<img height='100' width='100' src='".$receipt["ret_img"]."'></img>
		</div>
		...
		<img width='300' src='".$receipt["logo"]."'></img>
		</div>
