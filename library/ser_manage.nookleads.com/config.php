...
define("ADM_SECT", DOC_ROOT . INC_EMP . "sections.html");
define("ADM_REPT", DOC_ROOT . INC_EMP . "reports.html");
define("ADM_PROF", DOC_ROOT . INC_ADM . "profile.html");
define("ADM_PROF1", DOC_ROOT . INC_ADM . "channel.html");
define("ADM_PROF2", DOC_ROOT . INC_ADM . "posts.html");
define("ADM_PROF3", DOC_ROOT . INC_ADM . "sections.html");
define("ADM_PROF4", DOC_ROOT . INC_ADM . "users.html");
define("DOA_ADM_DASH", DOC_ROOT . CLASSES . ADMIN . "dashboard.php");
define("DOA_ADM_EMPS", DOC_ROOT . CLASSES . ADMIN . "employees.php");
define("DOA_ADM_EMPS1", DOC_ROOT . CLASSES . ADMIN . "employees1.php");
...
define("DOA_ADM_ACTY", DOC_ROOT . CLASSES . EMPLY . "activity.php");


 define("DOA_ADMIN_CONT", DOC_ROOT . CLASSES . EMPLY . "employees.php");
 define("DOA_ADMIN_COUN", DOC_ROOT . CLASSES . EMPLY . "projects.php");
 define("DOA_ADMIN_LANG", DOC_ROOT . CLASSES . EMPLY . "import.php");
 define("DOA_ADMIN_SEC", DOC_ROOT . CLASSES . EMPLY . "activity.php");
 define("DOA_ADMIN_RPT", DOC_ROOT . CLASSES . EMPLY . "report.php");
...
define('EXCEL_EMPLOYEEID', "EMPLOYEEID");
define('EXCEL_TELEPHONE', "TELEPHONE");
define('EXCEL_ADDRESS', "ADDRESS");
define('EXCEL_OCCUPATION', "OCCUPATION");
define('EXCEL_ACCESS_ID', "ACS ID");

define("DEFAULT_CHANEL_ICON_IMG", WEBURL .  "views/assets/img/channels/channel_logo.jpg");
define("DEFAULT_POST_IMG", WEBURL . "views/assets/img/wall/default-thumbnail.jpg");
define("DEFAULT_USER_ICON_IMG", WEBURL . "views/assets/img/profile/profle.jpg");
