...
//        var_dump($this->doc_path);
        $this->config = array(
//            "URL" => "http://local.managericepark.com/",
//            "URL" => "http://managerice.localmm.com/",
            "URL" => "http://manage.bhavaniindia.com/",
//            "DBHOST" => "192.168.0.10",
            "DBHOST" => "localhost",
//            "DBUSER" => "remote",
            "DBUSER" => "root",
...
//            "DBPASS" => "9743967575",
            ...
            "ASSSET_IMG" => "assets/images/",
            "ASSSET_PLG" => "assets/js/plugins/",
            "ASSSET_REG" => "assets/js/ricepark/",
            "ASSSET_BST" => "assets/bootstrap/",
            /* Mail constraints */
            "GMAIL_HOST" => "smtp.gmail.com",
            "GMAIL_PORT" => "587",
            "GMAIL_USER" => "rechargeportal.developer@gmail.com",
        ...
        $this->config["DEFAULT_LOGO"] = $this->config["URL"] .
                $this->config["VIEWS"] .
                $this->config["ASSSET_IMG"] . "Final.png";
        /* User */
        $this->config["DEFAULT_PRD_IMG"] = $this->config["URL"] .
                $this->config["VIEWS"] .
                $this->config["ASSSET_IMG"] . "i6.png";

        $this->config["DEFAULT_IMG"] = $this->config["URL"] .
                $this->config["VIEWS"] .
                $this->config["ASSSET_IMG"] . "ic10.jpg";
        ...
        $this->idHolders = array(
            "ricepark" => array(
                "dashboard" => $this->dashboard_ids->getIds(),
    ...
    public function createdirectories($directory) {
        ...
        $sruct_array = array(
            $this->config["DOC_ROOT"] . $this->config["DIRS"] . "$curr_dir/$directory/Images/",
