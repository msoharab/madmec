    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <header class="main-header">
                ...
                <a href="control.php" class="logo">
                    ...
                    <span class="logo-mini"><b>P</b>3P</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>Pic3Pic</b>&nbsp;Ver 1.0</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="javascript:void(0)" id="activity1">
                                <i class="fa fa-users"></i> <span>Users</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" id="activity2">
                                <i class="fa fa-television"></i> <span>Channels</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" id="activity3">
                                <i class="fa fa-circle-thin"></i> <span>Sections</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" id="activity4">
                                <i class="fa fa-list-alt"></i> <span>Posts</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" id="activity">
                                <i class="fa fa-map-marker"></i> <span>Continents</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" id="engage">
                                <i class="fa fa-map"></i> <span>Countries</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" id="import">
                                <i class="fa fa-book"></i> <span>Languages</span>
                            </a>
                        </li>
                        <!--<li>
                        ...
                        <li>
                            <a href="javascript:void(0)" href="javascript:void(0)" onclick="window.location.href = '<?php echo URL . 'logout.php'; ?>';">
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2014-2015 <a href="<?php echo URL . ASSET_DIR . ASSET_PLG; ?>">Pic3Pic Ver 1.0</a>.</strong> All rights reserved.
            </footer>
