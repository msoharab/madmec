...
class dashboardAdmin {
    ...
    public function __construct($param = false) {
        ...
        $this->query = array(
            "customers" => 'SELECT COUNT(`id`) FROM `user_profile` WHERE `user_type_id` = 2 AND `status` = 4;',
            "upcomming" => 'SELECT COUNT(`id`) FROM `projects` WHERE `status_id` = 4;',
            "inline" => 'SELECT COUNT(`id`) FROM `engage` WHERE `status_id` = 15;',
            "completed" => 'SELECT
        ...
        $this->jsondata = array(
            ...
            "graph" => 0,
            "graphdata" => array(),
            "graphhtml" => '<stong>0 Vehicles Make.</strong>'
        );
    }
