...
//            minTime : dat.getHours()+':'+(dat.getMinutes()),
    ...
    function fetchContinents()
    {
        $.ajax({
            ...
            data: {
                autoloader: true,
                action: 'adminimport/fetchContinents',
            },
    ...
    function  addProject(formdata)
    {
        $.ajax({
            type: 'POST',
            url: ctrl.url,
            data: formdata + '&autoloader=true&action=adminimport/addProject',
            success: function (data, textStatus, xhr) {
                console.log(data);
                data = $.trim(data);
                switch (data) {
    ...
    function fetchListOfProjects()
    {
        ...
        $.ajax({
            type: 'POST',
            url: ctrl.url,
            data: '&autoloader=true&action=adminimport/fetchListOfProjects',
            success: function (data, textStatus, xhr) {
                /*                                        console.log(data);*/
                data = $.trim(data);
    ...
    function deleteProject(id)
    {
        $.ajax({
            ...
            data: {
                autoloader: true,
                action: 'adminimport/deleteProject',
                typeid: id
            },
            success: function (data, textStatus, xhr) {
                /*                                        console.log(data);*/
    ...
    function updateProjectDetails(formdata)
    {
        ...
        $.ajax({
            type: 'POST',
            url: ctrl.url,
            data: formdata + '&autoloader=true&action=adminimport/updateProjectDetails',
            success: function (data, textStatus, xhr) {
                /*                                        console.log(data);*/
                data = $.trim(data);
                var res = $.parseJSON(data)
    ...
    function checkProjectName(proname)
    {
        $.ajax({
            ...
            data: {
                autoloader: true,
                action: 'adminimport/checkProjectName',
                proname: proname,
            },
            success: function (data, textStatus, xhr) {
                /*                                        console.log(data);*/
