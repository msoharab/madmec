...
//            minTime : dat.getHours()+':'+(dat.getMinutes()),
    ...
    function fetchContinents()
    {
        $.ajax({
            ...
            data: {
                autoloader: true,
                action: 'Projects/fetchContinents',
            },
    ...
    function  addProject(formdata)
    {
        $.ajax({
            type: 'POST',
            url: ctrl.url,
            data: formdata + '&autoloader=true&action=Projects/addProject',
            success: function (data, textStatus, xhr) {
                console.log(data);
                data = $.trim(data);
                switch (data) {
    ...
    function fetchListOfProjects()
    {
        ...
        $.ajax({
            type: 'POST',
            url: ctrl.url,
            data: '&autoloader=true&action=Projects/fetchListOfProjects',
            success: function (data, textStatus, xhr) {
                /*                                        console.log(data);*/
                data = $.trim(data);
                    ...
                    default:
                        ...
                        if (type.status == "success")
                        {
                            var header = '<div class="table-responsive"><table class="table table-responsive table-bordered table-hover" id="list_col_table"><thead>' +
                                    '<tr><th>#</th><th>Country Name</th><th>Capital</th><th>ISO</th><th>CurrencyCode</th><th>Continent Name</th><th>Option</th></tr></thead><tbody>';
    ...
    function updateProjectDetails(formdata)
    {
        ...
        $.ajax({
            type: 'POST',
            url: ctrl.url,
            data: formdata + '&autoloader=true&action=Projects/updateProjectDetails',
            success: function (data, textStatus, xhr) {
                /*                                        console.log(data);*/
                data = $.trim(data);
                var res = $.parseJSON(data)
    ...
    function checkProjectName(proname)
    {
        $.ajax({
            ...
            data: {
                autoloader: true,
                action: 'Projects/checkProjectName',
                proname: proname,
            },
            success: function (data, textStatus, xhr) {
                /*                                        console.log(data);*/
